...
describe('messaggioService', () => {
  describe('inviaMessaggio', () => {
    ...
    conversazione.getById.mockImplementation((id) => Promise.resolve({
      idConversazione: 1,
    ...
    messaggioService.buildListMessaggi = jest.fn().mockImplementation((dati) => [{ role: 'user', content: 'fakeContent' }, { role: 'assistant', content: 'fakeContent' }]);

...
var KTSignupGeneral = function () {
    ...
    return {init: function () {
            ...
            }(t.closest("form").getAttribute("action")) ? (r = FormValidation.formValidation(e, {fields: {"name": {validators: {notEmpty: {message: "Nome richiesto"}}}, "surname": {validators: {notEmpty: {message: "Cognome richiesto"}}}, username: {validators: {notEmpty: {message: "Username richiesto"}}}, birthday: {validators: {notEmpty: {message: "Data di nascita richiesta"}}}, phone: {} , email: {validators: {regexp: {regexp: /^[^\s@]+@[^\s@]+\.[^\s@]+$/, message: "E-mail non valida"}, notEmpty: {message: "E-mail richiesta"}}}, password: {validators: {notEmpty: {message: "Password richiesta"}, callback: {message: "Password non valida", callback: function (e) {

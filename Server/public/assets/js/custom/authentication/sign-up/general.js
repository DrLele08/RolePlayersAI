...
var KTSignupGeneral = function () {
    ...
    return {init: function () {
            ...
            }(t.closest("form").getAttribute("action")) ? (r = FormValidation.formValidation(e, {fields: {"name": {validators: {notEmpty: {message: "Nome richiesto"}}}, "surname": {validators: {notEmpty: {message: "Cognome richiesto"}}}, username: {validators: {notEmpty: {message: "Username richiesto"}}}, birthday: {validators: {regexp: {regexp: /^[^\s@]+@[^\s@]+\.[^\s@]+$/, message: "Data di nascita non valida"}, notEmpty: {message: "Data di nascita richiesta"}}}, email: {validators: {regexp: {regexp: /^[^\s@]+@[^\s@]+\.[^\s@]+$/, message: "E-mail non valida"}, notEmpty: {message: "E-mail richiesta"}}}, password: {validators: {notEmpty: {message: "Password richiesta"}, callback: {message: "Password non valida", callback: function (e) {

"use strict";
var KTCardsWidget1 = {init: function () {
        !function () {
            var e = document.getElementById("kt_card_widget_1_chart");
            if (e) {
                var t = e.getAttribute("data-kt-chart-color"), a = parseInt(KTUtil.css(e, "height")), l = KTUtil.getCssVariableValue("--bs-gray-500"), r = KTUtil.isHexColor(t) ? t : KTUtil.getCssVariableValue("--bs-" + t), o = KTUtil.getCssVariableValue("--bs-gray-300"), i = new ApexCharts(e, {series: [{name: "Sales", data: [30, 75, 55, 45, 30, 60, 75, 50], margin: {left: 5, right: 5}}], chart: {fontFamily: "inherit", type: "bar", height: a, toolbar: {show: false}, sparkline: {enabled: true}}, plotOptions: {bar: {horizontal: false, columnWidth: ["35%"], borderRadius: 6}}, legend: {show: false}, dataLabels: {enabled: false}, stroke: {show: true, width: 4, colors: ["transparent"]}, xaxis: {axisBorder: {show: false}, axisTicks: {show: false}, labels: {show: false, style: {colors: l, fontSize: "12px"}}, crosshairs: {show: false}}, yaxis: {labels: {show: false, style: {colors: l, fontSize: "12px"}}}, fill: {type: "solid"}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, x: {formatter: function (e) {
                                return "Feb: " + e;
                            }}, y: {formatter: function (e) {
                                return e + "%";
                            }}}, colors: [r, o], grid: {borderColor: false, strokeDashArray: 4, yaxis: {lines: {show: true}}, padding: {top: 10, left: 25, right: 25}}});
                setTimeout(function () {
                    i.render();
                }, 300);
            }
...
var KTCardsWidget10 = {init: function () {
        !function () {
            var e = document.getElementById("kt_card_widget_10_chart");
            if (e) {
                var t = {size: e.getAttribute("data-kt-size") ? parseInt(e.getAttribute("data-kt-size")) : 70, lineWidth: e.getAttribute("data-kt-line") ? parseInt(e.getAttribute("data-kt-line")) : 11, rotate: e.getAttribute("data-kt-rotate") ? parseInt(e.getAttribute("data-kt-rotate")) : 145}, a = document.createElement("canvas"), l = document.createElement("span");
                ...
                var o = (t.size - t.lineWidth) / 2, i = function (e, t, a) {
                    a = Math.min(Math.max(0, a || 1), 1), r.beginPath(), r.arc(0, 0, o, 0, 2 * Math.PI * a, false), r.strokeStyle = e, r.lineCap = "round", r.lineWidth = t, r.stroke();
                };
                i("#E4E6EF", t.lineWidth, 1), i(KTUtil.getCssVariableValue("--bs-primary"), t.lineWidth, 0.6666666666666666), i(KTUtil.getCssVariableValue("--bs-success"), t.lineWidth, 0.4);
            }
        }();
    }};
...
var KTCardWidget12 = function () {
    var e = {self: null, rendered: false}, t = function (e) {
        var t = document.getElementById("kt_card_widget_12_chart");
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-border-dashed-color"), r = KTUtil.getCssVariableValue("--bs-gray-800"), o = {series: [{name: "Sales", data: [3.5, 5.7, 2.8, 5.9, 4.2, 5.6, 4.3, 4.5, 5.9, 4.5, 5.7, 4.8, 5.7]}], chart: {fontFamily: "inherit", type: "area", height: a, toolbar: {show: false}}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "solid", opacity: 0}, stroke: {curve: "smooth", show: true, width: 2, colors: [r]}, xaxis: {axisBorder: {show: false}, axisTicks: {show: false}, labels: {show: false}, crosshairs: {position: "front", stroke: {color: r, width: 1, dashArray: 3}}, tooltip: {enabled: true, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}}, yaxis: {labels: {show: false}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, x: {formatter: function (e) {
                            return "Feb " + e;
                        }}, y: {formatter: function (e) {
                            return "10" * e + "K";
                        }}}, colors: [KTUtil.getCssVariableValue("--bs-success")], grid: {borderColor: l, strokeDashArray: 4, padding: {top: 0, right: -20, bottom: -20, left: -20}, yaxis: {lines: {show: true}}}, markers: {strokeColor: r, strokeWidth: 2}};
...
var KTCardWidget13 = function () {
    var e = {self: null, rendered: false}, t = function (e) {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-border-dashed-color"), r = KTUtil.getCssVariableValue("--bs-gray-800"), o = {series: [{name: "Shipments", data: [1.5, 4.5, 2, 3, 2, 4, 2.5, 2, 2.5, 4, 3.5, 4.5, 2.5]}], chart: {fontFamily: "inherit", type: "area", height: a, toolbar: {show: false}}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "solid", opacity: 0}, stroke: {curve: "smooth", show: true, width: 2, colors: [r]}, xaxis: {axisBorder: {show: false}, axisTicks: {show: false}, labels: {show: false}, crosshairs: {position: "front", stroke: {color: r, width: 1, dashArray: 3}}, tooltip: {enabled: true, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}}, yaxis: {labels: {show: false}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, x: {formatter: function (e) {
                            return "Feb " + e;
                        }}, y: {formatter: function (e) {
                            return "10" * e + "K";
                        }}}, colors: [KTUtil.getCssVariableValue("--bs-success")], grid: {borderColor: l, strokeDashArray: 4, padding: {top: 0, right: -20, bottom: -20, left: -20}, yaxis: {lines: {show: true}}}, markers: {strokeColor: r, strokeWidth: 2}};
...
var KTCardsWidget17 = {init: function () {
        !function () {
...
var KTCardsWidget19 = {init: function () {
        !function () {
...
var KTCardsWidget4 = {init: function () {
        !function () {
            ...
            if (e) {
                ...
                i("#E4E6EF", t.lineWidth, 1), i(KTUtil.getCssVariableValue("--bs-danger"), t.lineWidth, 0.6666666666666666), i(KTUtil.getCssVariableValue("--bs-primary"), t.lineWidth, 0.4);
            }
        }();
    }};
...
var KTCardsWidget6 = {init: function () {
        !function () {
            var e = document.getElementById("kt_card_widget_6_chart");
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")), a = KTUtil.getCssVariableValue("--bs-gray-500"), l = KTUtil.getCssVariableValue("--bs-border-dashed-color"), r = KTUtil.getCssVariableValue("--bs-primary"), o = KTUtil.getCssVariableValue("--bs-gray-300"), i = new ApexCharts(e, {series: [{name: "Sales", data: [30, 60, 53, 45, 60, 75, 53]}], chart: {fontFamily: "inherit", type: "bar", height: t, toolbar: {show: false}, sparkline: {enabled: true}}, plotOptions: {bar: {horizontal: false, columnWidth: ["55%"], borderRadius: 6}}, legend: {show: false}, dataLabels: {enabled: false}, stroke: {show: true, width: 9, colors: ["transparent"]}, xaxis: {axisBorder: {show: false}, axisTicks: {show: false, tickPlacement: "between"}, labels: {show: false, style: {colors: a, fontSize: "12px"}}, crosshairs: {show: false}}, yaxis: {labels: {show: false, style: {colors: a, fontSize: "12px"}}}, fill: {type: "solid"}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, x: {formatter: function (e) {
                                return "Feb: " + e;
                            }}, y: {formatter: function (e) {
                                return e + "%";
                            }}}, colors: [r, o], grid: {padding: {left: 10, right: 10}, borderColor: l, strokeDashArray: 4, yaxis: {lines: {show: true}}}});
                setTimeout(function () {
                    i.render();
                }, 300);
            }
...
var KTCardWidget8 = function () {
    var e = {self: null, rendered: false}, t = function (e) {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-border-dashed-color"), r = KTUtil.getCssVariableValue("--bs-gray-800"), o = {series: [{name: "Sales", data: [4.5, 5.7, 2.8, 5.9, 4.2, 5.6, 5.2, 4.5, 5.9, 4.5, 5.7, 4.8, 5.7]}], chart: {fontFamily: "inherit", type: "area", height: a, toolbar: {show: false}}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "solid", opacity: 0}, stroke: {curve: "smooth", show: true, width: 2, colors: [r]}, xaxis: {axisBorder: {show: false}, axisTicks: {show: false}, labels: {show: false}, crosshairs: {position: "front", stroke: {color: r, width: 1, dashArray: 3}}, tooltip: {enabled: true, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}}, yaxis: {labels: {show: false}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, x: {formatter: function (e) {
                            return "Feb " + e;
                        }}, y: {formatter: function (e) {
                            return "$" + e + "K";
                        }}}, colors: [KTUtil.getCssVariableValue("--bs-success")], grid: {borderColor: l, strokeDashArray: 4, padding: {top: 0, right: -20, bottom: -20, left: -20}, yaxis: {lines: {show: true}}}, markers: {strokeColor: r, strokeWidth: 2}};
...
var KTCardWidget9 = function () {
    var e = {self: null, rendered: false}, t = function (e) {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-border-dashed-color"), r = KTUtil.getCssVariableValue("--bs-gray-800"), o = {series: [{name: "Visitors", data: [1.5, 2.5, 2, 3, 2, 4, 2.5, 2, 2.5, 4, 2.5, 4.5, 2.5]}], chart: {fontFamily: "inherit", type: "area", height: a, toolbar: {show: false}}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "solid", opacity: 0}, stroke: {curve: "smooth", show: true, width: 2, colors: [r]}, xaxis: {axisBorder: {show: false}, axisTicks: {show: false}, labels: {show: false}, crosshairs: {position: "front", stroke: {color: r, width: 1, dashArray: 3}}, tooltip: {enabled: true, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}}, yaxis: {labels: {show: false}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, x: {formatter: function (e) {
                            return "Feb " + e;
                        }}, y: {formatter: function (e) {
                            return e + "K";
                        }}}, colors: [KTUtil.getCssVariableValue("--bs-success")], grid: {borderColor: l, strokeDashArray: 4, padding: {top: 0, right: -20, bottom: -20, left: -20}, yaxis: {lines: {show: true}}}, markers: {strokeColor: r, strokeWidth: 2}};
...
var KTFormsWidget1 = {init: function () {
        !function () {
            ...
            if (e) {
                ...
                $(e).select2({placeholder: "Select coin", minimumResultsForSearch: Infinity, templateSelection: t, templateResult: t});
            }
        }(), function () {
...
var KTTimelineWidget24 = {init: function () {
        var e;
...
var KTMapsWidget1 = {init: function () {
        !function () {
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t, a = function () {
                        ...
                        var a = t.container.children.push(am5map.MapChart.new(t, {panX: "translateX", panY: "translateY", projection: am5map.geoMercator(), paddingLeft: 0, paddingrIGHT: 0, paddingBottom: 0})), l = a.series.push(am5map.MapPolygonSeries.new(t, {geoJSON: am5geodata_worldLow, exclude: ["AQ"]}));
                        l.mapPolygons.template.setAll({tooltipText: "{name}", toggleKey: "active", interactive: true, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-300"))}), l.mapPolygons.template.states.create("hover", {fill: am5.color(KTUtil.getCssVariableValue("--bs-success"))}), l.mapPolygons.template.states.create("active", {fill: am5.color(KTUtil.getCssVariableValue("--bs-success"))});
                        var r = a.series.push(am5map.MapPolygonSeries.new(t, {geoJSON: am5geodata_worldLow, include: ["US", "BR", "DE", "AU", "JP"]}));
                        r.mapPolygons.template.setAll({tooltipText: "{name}", toggleKey: "active", interactive: true}), am5.ColorSet.new(t, {}), r.mapPolygons.template.set("fill", am5.color(KTUtil.getCssVariableValue("--bs-primary"))), r.mapPolygons.template.states.create("hover", {fill: t.interfaceColors.get("primaryButtonHover")}), r.mapPolygons.template.states.create("active", {fill: t.interfaceColors.get("primaryButtonHover")}), a.chartContainer.get("background").events.on("click", function () {
                            a.goHome();
                        }), a.appear(1e3, 100);
                    };
                    am5.ready(function () {
...
var KTMapsWidget2 = {init: function () {
        !function () {
            if ("undefined" != typeof am5) {
...
var KTPlayersWidget1 = {init: function () {
        KTUtil.on(document.body, '[data-kt-element="list-play-button"]', "click", function (e) {
            var t = this, a = document.querySelector('[data-kt-element="audio-track-1"]'), l = this.querySelector('[data-kt-element="list-play-icon"]'), r = this.querySelector('[data-kt-element="list-pause-icon"]');
            r.classList.contains("d-none") ? (a.play(), l.classList.add("d-none"), r.classList.remove("d-none")) : (a.pause(), l.classList.remove("d-none"), r.classList.add("d-none")), [].slice.call(document.querySelectorAll('[data-kt-element="list-play-button"]')).map(function (e) {
                if (e !== t) {
                    var a = e.querySelector('[data-kt-element="list-play-icon"]'), l = e.querySelector('[data-kt-element="list-pause-icon"]');
...
var KTSlidersWidget1 = function () {
    var e = {self: null, rendered: false}, t = {self: null, rendered: false}, a = {self: null, rendered: false}, l = function (e, t, a) {
        var l = document.querySelector(t);
        if (l && (true !== e.rendered || !l.classList.contains("initialized"))) {
            var r = parseInt(KTUtil.css(l, "height")), o = KTUtil.getCssVariableValue("--bs-primary"), i = {series: [a], chart: {fontFamily: "inherit", height: r, type: "radialBar", sparkline: {enabled: true}}, plotOptions: {radialBar: {hollow: {margin: 0, size: "45%"}, dataLabels: {showOn: "always", name: {show: false}, value: {show: false}}, track: {background: KTUtil.getCssVariableValue("--bs-primary-light"), strokeWidth: "100%"}}}, colors: [o], stroke: {lineCap: "round"}, labels: ["Progress"]};
            e.self = new ApexCharts(l, i), e.self.render(), e.rendered = true, l.classList.add("initialized");
        }
    };
    return {init: function () {
            ...
            r && (r.addEventListener("slid.bs.carousel", function (e) {
                ...
                e.rendered && (e.self.destroy(), e.rendered = false), t.rendered && (t.self.destroy(), t.rendered = false), a.rendered && (a.self.destroy(), a.rendered = false), l(e, "#kt_slider_widget_1_chart_1", 76), l(t, "#kt_slider_widget_1_chart_2", 55), l(a, "#kt_slider_widget_1_chart_3", 25);
            }));
        }};
}();
...
var KTSlidersWidget3 = function () {
    var e = {self: null, rendered: false}, t = {self: null, rendered: false}, a = function (e, t, a, l) {
        var r = document.querySelector(t);
        if (r && (true !== e.rendered || !r.classList.contains("initialized"))) {
            var o = parseInt(KTUtil.css(r, "height")), i = KTUtil.getCssVariableValue("--bs-gray-500"), s = KTUtil.getCssVariableValue("--bs-border-dashed-color"), n = KTUtil.getCssVariableValue("--bs-" + a), d = {series: [{name: "Lessons", data: l}], chart: {fontFamily: "inherit", type: "area", height: o, toolbar: {show: false}}, plotOptions: {}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "gradient", gradient: {shadeIntensity: 1, opacityFrom: 0.4, opacityTo: 0, stops: [0, 80, 100]}}, stroke: {curve: "smooth", show: true, width: 3, colors: [n]}, xaxis: {categories: ["", "Apr 05", "Apr 06", "Apr 07", "Apr 08", "Apr 09", "Apr 11", "Apr 12", "Apr 14", "Apr 15", "Apr 16", "Apr 17", "Apr 18", ""], axisBorder: {show: false}, axisTicks: {show: false}, tickAmount: 6, labels: {rotate: 0, rotateAlways: true, style: {colors: i, fontSize: "12px"}}, crosshairs: {position: "front", stroke: {color: n, width: 1, dashArray: 3}}, tooltip: {enabled: true, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}}, yaxis: {tickAmount: 4, max: 24, min: 10, labels: {style: {colors: i, fontSize: "12px"}}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}}, colors: [n], grid: {borderColor: s, strokeDashArray: 4, yaxis: {lines: {show: true}}}, markers: {strokeColor: n, strokeWidth: 3}};
            e.self = new ApexCharts(r, d), e.self.render(), e.rendered = true, r.classList.add("initialized");
        }
    };
    return {init: function () {
            var l = [19, 21, 21, 20, 20, 18, 18, 20, 20, 22, 22, 21, 21, 22], r = [18, 22, 22, 20, 20, 18, 18, 20, 20, 18, 18, 20, 20, 22];
            ...
            o && (o.addEventListener("slid.bs.carousel", function (e) {
                ...
                e.rendered && (e.self.destroy(), e.rendered = false), t.rendered && (t.self.destroy(), t.rendered = false), a(e, "#kt_sliders_widget_3_chart_1", "danger", l), a(t, "#kt_sliders_widget_3_chart_2", "primary", r);
            }));
        }};
}();
...
var KTSlidersWidget7 = function () {
    var e = {self: null, rendered: false}, t = {self: null, rendered: false}, a = {self: null, rendered: false}, l = function (e, t, a) {
        var l = document.querySelector(t);
        if (l && (true !== e.rendered || !l.classList.contains("initialized"))) {
            var r = parseInt(KTUtil.css(l, "height")), o = KTUtil.getCssVariableValue("--bs-danger"), i = {series: [a], chart: {fontFamily: "inherit", height: r, type: "radialBar", sparkline: {enabled: true}}, plotOptions: {radialBar: {hollow: {margin: 0, size: "45%"}, dataLabels: {showOn: "always", name: {show: false}, value: {show: false}}, track: {background: KTUtil.getCssVariableValue("--bs-white"), strokeWidth: "100%"}}}, colors: [o], stroke: {lineCap: "round"}, labels: ["Progress"]};
            e.self = new ApexCharts(l, i), e.self.render(), e.rendered = true, l.classList.add("initialized");
        }
    };
    return {init: function () {
            ...
            r && (r.addEventListener("slid.bs.carousel", function (e) {
                ...
                e.rendered && (e.self.destroy(), e.rendered = false), t.rendered && (t.self.destroy(), t.rendered = false), a.rendered && (a.self.destroy(), a.rendered = false), l(e, "#kt_slider_widget_7_chart_1", 76), l(t, "#kt_slider_widget_7_chart_2", 55), l(a, "#kt_slider_widget_7_chart_3", 25);
            }));
        }};
}();
...
var KTChartsWidget1 = function () {
    var e = {self: null, rendered: false}, t = function () {
        var t = document.getElementById("kt_charts_widget_1");
        if (t) {
            var a = t.hasAttribute("data-kt-negative-color") ? t.getAttribute("data-kt-negative-color") : KTUtil.getCssVariableValue("--bs-success"), l = parseInt(KTUtil.css(t, "height")), r = KTUtil.getCssVariableValue("--bs-gray-500"), o = KTUtil.getCssVariableValue("--bs-border-dashed-color"), i = {series: [{name: "Subscribed", data: [20, 30, 20, 40, 60, 75, 65, 18, 10, 5, 15, 40, 60, 18, 35, 55, 20]}, {name: "Unsubscribed", data: [-20, -15, -5, -20, -30, -15, -10, -8, -5, -5, -10, -25, -15, -5, -10, -5, -15]}], chart: {fontFamily: "inherit", type: "bar", stacked: true, height: l, toolbar: {show: false}}, plotOptions: {bar: {columnWidth: "35%", barHeight: "70%", borderRadius: [6, 6]}}, legend: {show: false}, dataLabels: {enabled: false}, xaxis: {categories: ["Jan 5", "Jan 7", "Jan 9", "Jan 11", "Jan 13", "Jan 15", "Jan 17", "Jan 19", "Jan 20", "Jan 21", "Jan 23", "Jan 24", "Jan 25", "Jan 26", "Jan 24", "Jan 28", "Jan 29"], axisBorder: {show: false}, axisTicks: {show: false}, tickAmount: 10, labels: {style: {colors: [r], fontSize: "12px"}}, crosshairs: {show: false}}, yaxis: {min: -50, max: 80, tickAmount: 6, labels: {style: {colors: [r], fontSize: "12px"}, formatter: function (e) {
                            return parseInt(e) + "K";
                        }}}, fill: {opacity: 1}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px", borderRadius: 4}, y: {formatter: function (e) {
                            return e > 0 ? e + "K" : Math.abs(e) + "K";
                        }}}, colors: [KTUtil.getCssVariableValue("--bs-primary"), a], grid: {borderColor: o, strokeDashArray: 4, yaxis: {lines: {show: true}}}};
...
var KTChartsWidget10 = function () {
    var e = {self: null, rendered: false}, t = {self: null, rendered: false}, a = {self: null, rendered: false}, l = {self: null, rendered: false}, r = function (e, t, a, l, r) {
        var o = document.querySelector(a);
        if (o) {
            var i = parseInt(KTUtil.css(o, "height")), s = KTUtil.getCssVariableValue("--bs-gray-900"), n = KTUtil.getCssVariableValue("--bs-border-dashed-color"), d = {series: [{name: "Achieved Target", data: l}], chart: {fontFamily: "inherit", type: "bar", height: i, toolbar: {show: false}}, plotOptions: {bar: {horizontal: false, columnWidth: ["22%"], borderRadius: 5, dataLabels: {position: "top"}, startingShape: "flat"}}, legend: {show: false}, dataLabels: {enabled: true, offsetY: -30, style: {fontSize: "13px", colors: [s]}, formatter: function (e) {
                        return e + "K";
                    }}, stroke: {show: true, width: 2, colors: ["transparent"]}, xaxis: {categories: ["Metals", "Energy", "Agro", "Machines", "Transport", "Textile", "Wood"], axisBorder: {show: false}, axisTicks: {show: false}, labels: {style: {colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px"}}, crosshairs: {fill: {gradient: {opacityFrom: 0, opacityTo: 0}}}}, yaxis: {labels: {style: {colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px"}, formatter: function (e) {
                            return parseInt(e) + "K";
                        }}}, fill: {opacity: 1}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, y: {formatter: function (e) {
                            return +e + "K";
                        }}}, colors: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-primary-light")], grid: {borderColor: n, strokeDashArray: 4, yaxis: {lines: {show: true}}}};
            e.self = new ApexCharts(o, d);
            var m = document.querySelector(t);
            true === r && setTimeout(function () {
                e.self.render(), e.rendered = true;
            }, 200), m.addEventListener("shown.bs.tab", function (t) {
                false === e.rendered && (e.self.render(), e.rendered = true);
            });
        }
    };
    return {init: function () {
            var o = [30, 18, 43, 70, 13, 37, 23];
            r(e, "#kt_charts_widget_10_tab_1", "#kt_charts_widget_10_chart_1", o, true);
            var i = [25, 55, 35, 50, 45, 20, 31];
            r(t, "#kt_charts_widget_10_tab_2", "#kt_charts_widget_10_chart_2", i, false);
            var s = [45, 15, 35, 70, 45, 50, 21];
            r(a, "#kt_charts_widget_10_tab_3", "#kt_charts_widget_10_chart_3", s, false);
            var n = [15, 55, 25, 50, 25, 60, 31];
            r(l, "#kt_charts_widget_10_tab_4", "#kt_charts_widget_10_chart_4", n, false), KTThemeMode.on("kt.thememode.change", function () {
...
var KTChartsWidget11 = function () {
    var e = {self: null, rendered: false}, t = {self: null, rendered: false}, a = {self: null, rendered: false}, l = function (e, t, a, l, r) {
        var o = document.querySelector(a), i = parseInt(KTUtil.css(o, "height"));
        if (o) {
            var s = KTUtil.getCssVariableValue("--bs-gray-500"), n = KTUtil.getCssVariableValue("--bs-border-dashed-color"), d = KTUtil.getCssVariableValue("--bs-success"), m = {series: [{name: "Deliveries", data: l}], chart: {fontFamily: "inherit", type: "area", height: i, toolbar: {show: false}}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "gradient", gradient: {shadeIntensity: 1, opacityFrom: 0.4, opacityTo: 0, stops: [0, 80, 100]}}, stroke: {curve: "smooth", show: true, width: 3, colors: [d]}, xaxis: {categories: ["", "Apr 02", "Apr 06", "Apr 06", "Apr 05", "Apr 06", "Apr 10", "Apr 08", "Apr 09", "Apr 14", "Apr 10", "Apr 12", "Apr 18", "Apr 14", "Apr 15", "Apr 14", "Apr 17", "Apr 18", "Apr 02", "Apr 06", "Apr 18", "Apr 05", "Apr 06", "Apr 10", "Apr 08", "Apr 22", "Apr 14", "Apr 11", "Apr 12", ""], axisBorder: {show: false}, axisTicks: {show: false}, tickAmount: 5, labels: {rotate: 0, rotateAlways: true, style: {colors: s, fontSize: "13px"}}, crosshairs: {position: "front", stroke: {color: d, width: 1, dashArray: 3}}, tooltip: {enabled: true, formatter: void 0, offsetY: 0, style: {fontSize: "13px"}}}, yaxis: {tickAmount: 4, max: 24, min: 10, labels: {style: {colors: s, fontSize: "13px"}}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, y: {formatter: function (e) {
                            return +e;
                        }}}, colors: [d], grid: {borderColor: n, strokeDashArray: 3, yaxis: {lines: {show: true}}}, markers: {strokeColor: d, strokeWidth: 3}};
    ...
    return {init: function () {
            ...
            l(e, "#kt_charts_widget_11_tab_1", "#kt_charts_widget_11_chart_1", r, false);
            var o = [18, 18, 20, 20, 18, 18, 22, 22, 20, 20, 18, 18, 20, 20, 18, 18, 20, 20, 22, 15, 18, 18, 17, 17, 15, 15, 17, 17, 19, 17];
            l(t, "#kt_charts_widget_11_tab_2", "#kt_charts_widget_11_chart_2", o, false);
            var i = [17, 20, 20, 19, 19, 17, 17, 19, 19, 21, 21, 19, 19, 21, 21, 18, 18, 16, 17, 17, 19, 19, 21, 21, 19, 19, 17, 17, 18, 18];
            l(a, "#kt_charts_widget_11_tab_3", "#kt_charts_widget_11_chart_3", i, true), KTThemeMode.on("kt.thememode.change", function () {
...
var KTChartsWidget12 = function () {
    var e = function (e, t, a, l) {
        var r = document.querySelector(t);
        if (r) {
            var o = parseInt(KTUtil.css(r, "height")), i = KTUtil.getCssVariableValue("--bs-gray-900"), s = KTUtil.getCssVariableValue("--bs-border-dashed-color"), n = {series: [{name: "Deliveries", data: a}], chart: {fontFamily: "inherit", type: "bar", height: o, toolbar: {show: false}}, plotOptions: {bar: {horizontal: false, columnWidth: ["22%"], borderRadius: 5, dataLabels: {position: "top"}, startingShape: "flat"}}, legend: {show: false}, dataLabels: {enabled: true, offsetY: -28, style: {fontSize: "13px", colors: i}, formatter: function (e) {
                        return e + "K";
                    }}, stroke: {show: true, width: 2, colors: ["transparent"]}, xaxis: {categories: ["Grossey", "Pet Food", "Flowers", "Restaurant", "Kids Toys", "Clothing", "Still Water"], axisBorder: {show: false}, axisTicks: {show: false}, labels: {style: {colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px"}}, crosshairs: {fill: {gradient: {opacityFrom: 0, opacityTo: 0}}}}, yaxis: {labels: {style: {colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px"}, formatter: function (e) {
                            return e + "K";
                        }}}, fill: {opacity: 1}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, y: {formatter: function (e) {
                            return +e + "K";
                        }}}, colors: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-primary-light")], grid: {borderColor: s, strokeDashArray: 4, yaxis: {lines: {show: true}}}}, d = new ApexCharts(r, n), m = false, c = document.querySelector(e);
            true === l && (d.render(), m = true), c.addEventListener("shown.bs.tab", function (e) {
                0 == m && (d.render(), m = true);
            });
        }
    };
    return {init: function () {
            e("#kt_charts_widget_12_tab_1", "#kt_charts_widget_12_chart_1", [54, 42, 75, 110, 23, 87, 50], true), e("#kt_charts_widget_12_tab_2", "#kt_charts_widget_12_chart_2", [25, 55, 35, 50, 45, 20, 31], false), e("#kt_charts_widget_12_tab_3", "#kt_charts_widget_12_chart_3", [45, 15, 35, 70, 45, 50, 21], false);
        }};
}();
"undefined" != typeof module && (module.exports = KTChartsWidget12), KTUtil.onDOMContentLoaded(function () {
    KTChartsWidget12.init();
});
var KTChartsWidget13 = {init: function () {
        !function () {
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t, a = function () {
                        (t = am5.Root.new(e)).setThemes([am5themes_Animated.new(t)]);
                        var a = t.container.children.push(am5xy.XYChart.new(t, {panX: true, panY: true, wheelX: "panX", wheelY: "zoomX"}));
                        a.set("cursor", am5xy.XYCursor.new(t, {behavior: "none"})).lineY.set("visible", false);
                        var l = [{year: "2003", cars: 1587, motorcycles: 650, bicycles: 121}, {year: "2004", cars: 1567, motorcycles: 683, bicycles: 146}, {year: "2005", cars: 1617, motorcycles: 691, bicycles: 138}, {year: "2006", cars: 1630, motorcycles: 642, bicycles: 127}, {year: "2007", cars: 1660, motorcycles: 699, bicycles: 105}, {year: "2008", cars: 1683, motorcycles: 721, bicycles: 109}, {year: "2009", cars: 1691, motorcycles: 737, bicycles: 112}, {year: "2010", cars: 1298, motorcycles: 680, bicycles: 101}, {year: "2011", cars: 1275, motorcycles: 664, bicycles: 97}, {year: "2012", cars: 1246, motorcycles: 648, bicycles: 93}, {year: "2013", cars: 1318, motorcycles: 697, bicycles: 111}, {year: "2014", cars: 1213, motorcycles: 633, bicycles: 87}, {year: "2015", cars: 1199, motorcycles: 621, bicycles: 79}, {year: "2016", cars: 1110, motorcycles: 210, bicycles: 81}, {year: "2017", cars: 1165, motorcycles: 232, bicycles: 75}, {year: "2018", cars: 1145, motorcycles: 219, bicycles: 88}, {year: "2019", cars: 1163, motorcycles: 201, bicycles: 82}, {year: "2020", cars: 1180, motorcycles: 285, bicycles: 87}, {year: "2021", cars: 1159, motorcycles: 277, bicycles: 71}], r = a.xAxes.push(am5xy.CategoryAxis.new(t, {categoryField: "year", startLocation: 0.5, endLocation: 0.5, renderer: am5xy.AxisRendererX.new(t, {}), tooltip: am5.Tooltip.new(t, {})}));
                        r.get("renderer").grid.template.setAll({disabled: true, strokeOpacity: 0}), r.get("renderer").labels.template.setAll({fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))}), r.data.setAll(l);
                        var o = a.yAxes.push(am5xy.ValueAxis.new(t, {renderer: am5xy.AxisRendererY.new(t, {})}));
                        function i(e, i, s) {
                            var n = a.series.push(am5xy.LineSeries.new(t, {name: e, xAxis: r, yAxis: o, stacked: true, valueYField: i, categoryXField: "year", fill: am5.color(s), tooltip: am5.Tooltip.new(t, {pointerOrientation: "horizontal", labelText: "[bold]{name}[/]\n{categoryX}: {valueY}"})}));
                            n.fills.template.setAll({fillOpacity: 0.5, visible: true}), n.data.setAll(l), n.appear(1e3);
                        }
                        o.get("renderer").grid.template.setAll({stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3]}), o.get("renderer").labels.template.setAll({fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))}), i("Cars", "cars", KTUtil.getCssVariableValue("--bs-primary")), i("Motorcycles", "motorcycles", KTUtil.getCssVariableValue("--bs-success")), i("Bicycles", "bicycles", KTUtil.getCssVariableValue("--bs-warning")), a.set("scrollbarX", am5.Scrollbar.new(t, {orientation: "horizontal", marginBottom: 25, height: 8}));
                        var s = r.makeDataItem({category: "2016", endCategory: "2021"});
                        r.createAxisRange(s), s.get("grid").setAll({stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-200")), strokeOpacity: 0.5, strokeDasharray: [3]}), s.get("axisFill").setAll({fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-200")), fillOpacity: 0.1}), s.get("label").setAll({inside: true, text: "Fines increased", rotation: 90, centerX: am5.p100, centerY: am5.p100, location: 0, paddingBottom: 10, paddingRight: 15});
                        var n = r.makeDataItem({category: "2021"});
                        r.createAxisRange(n), n.get("grid").setAll({stroke: am5.color(KTUtil.getCssVariableValue("--bs-danger")), strokeOpacity: 1, strokeDasharray: [3]}), n.get("label").setAll({inside: true, text: "Fee introduced", rotation: 90, centerX: am5.p100, centerY: am5.p100, location: 0, paddingBottom: 10, paddingRight: 15}), a.appear(1e3, 100);
                    };
                    am5.ready(function () {
                        a();
                    }), KTThemeMode.on("kt.thememode.change", function () {
...
var KTChartsWidget14 = {init: function () {
        !function () {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready(function () {
                    ...
                    var a = t.container.children.push(am5radar.RadarChart.new(t, {panX: false, panY: false, wheelX: "panX", wheelY: "zoomX", innerRadius: am5.percent(20), startAngle: -90, endAngle: 180})), l = [{category: "Research", value: 80, full: 100, columnSettings: {fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-info"))}}, {category: "Marketing", value: 35, full: 100, columnSettings: {fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-danger"))}}, {category: "Distribution", value: 92, full: 100, columnSettings: {fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-primary"))}}, {category: "Human Resources", value: 68, full: 100, columnSettings: {fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-success"))}}];
                    a.set("cursor", am5radar.RadarCursor.new(t, {behavior: "zoomX"})).lineY.set("visible", false);
                    var r = am5radar.AxisRendererCircular.new(t, {});
                    r.labels.template.setAll({radius: 10}), r.grid.template.setAll({forceHidden: true});
                    var o = a.xAxes.push(am5xy.ValueAxis.new(t, {renderer: r, min: 0, max: 100, strictMinMax: true, numberFormat: "#'%'", tooltip: am5.Tooltip.new(t, {})}));
                    ...
                    i.labels.template.setAll({centerX: am5.p100, fontWeight: "500", fontSize: 18, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")), templateField: "columnSettings"}), i.grid.template.setAll({forceHidden: true});
                    var s = a.yAxes.push(am5xy.CategoryAxis.new(t, {categoryField: "category", renderer: i}));
                    s.data.setAll(l);
                    var n = a.series.push(am5radar.RadarColumnSeries.new(t, {xAxis: o, yAxis: s, clustered: false, valueXField: "full", categoryYField: "category", fill: t.interfaceColors.get("alternativeBackground")}));
                    n.columns.template.setAll({width: am5.p100, fillOpacity: 0.08, strokeOpacity: 0, cornerRadius: 20}), n.data.setAll(l);
                    var d = a.series.push(am5radar.RadarColumnSeries.new(t, {xAxis: o, yAxis: s, clustered: false, valueXField: "value", categoryYField: "category"}));
                    d.columns.template.setAll({width: am5.p100, strokeOpacity: 0, tooltipText: "{category}: {valueX}%", cornerRadius: 20, templateField: "columnSettings"}), d.data.setAll(l), n.appear(1e3), d.appear(1e3), a.appear(1e3, 100);
                });
            }
        }();
    }};
...
var KTChartsWidget15 = {init: function () {
        !function () {
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t, a = function () {
                        ...
                        r.get("renderer").labels.template.setAll({paddingTop: 20, fontWeight: "400", fontSize: 10, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))}), r.get("renderer").grid.template.setAll({disabled: true, strokeOpacity: 0}), r.data.setAll(l);
                        var o = a.yAxes.push(am5xy.ValueAxis.new(t, {renderer: am5xy.AxisRendererY.new(t, {})}));
                        o.get("renderer").grid.template.setAll({stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3]}), o.get("renderer").labels.template.setAll({fontWeight: "400", fontSize: 10, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))});
                        var i = a.series.push(am5xy.ColumnSeries.new(t, {xAxis: r, yAxis: o, valueYField: "visits", categoryXField: "country"}));
                        i.columns.template.setAll({tooltipText: "{categoryX}: {valueY}", tooltipY: 0, strokeOpacity: 0, templateField: "columnSettings"}), i.columns.template.setAll({strokeOpacity: 0, cornerRadiusBR: 0, cornerRadiusTR: 6, cornerRadiusBL: 0, cornerRadiusTL: 6}), i.data.setAll(l), i.appear(), a.appear(1e3, 100);
                    };
                    am5.ready(function () {
                        a();
                    }), KTThemeMode.on("kt.thememode.change", function () {
...
var KTChartsWidget16 = {init: function () {
        !function () {
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t, a = function () {
                        ...
                        r.get("renderer").labels.template.setAll({paddingTop: 10, fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))}), r.get("renderer").grid.template.setAll({disabled: true, strokeOpacity: 0}), r.data.setAll(l);
                        var o = a.yAxes.push(am5xy.ValueAxis.new(t, {renderer: am5xy.AxisRendererY.new(t, {})}));
                        o.get("renderer").labels.template.setAll({paddingLeft: 10, fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))}), o.get("renderer").grid.template.setAll({stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3]});
                        var i = am5xy.AxisRendererY.new(t, {opposite: true}), s = a.yAxes.push(am5xy.ValueAxis.new(t, {renderer: i, min: 0, max: 100, strictMinMax: true}));
                        s.get("renderer").labels.template.setAll({fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))}), i.grid.template.set("forceHidden", true), s.set("numberFormat", "#'%");
                        var n = a.series.push(am5xy.ColumnSeries.new(t, {xAxis: r, yAxis: o, valueYField: "visits", categoryXField: "country"}));
                        n.columns.template.setAll({tooltipText: "{categoryX}: {valueY}", tooltipY: 0, strokeOpacity: 0, cornerRadiusTL: 6, cornerRadiusTR: 6}), n.columns.template.adapters.add("fill", function (e, t) {
                            return a.get("colors").getIndex(n.dataItems.indexOf(t.dataItem));
                        });
                        var d = a.series.push(am5xy.LineSeries.new(t, {xAxis: r, yAxis: s, valueYField: "pareto", categoryXField: "country", stroke: am5.color(KTUtil.getCssVariableValue("--bs-dark")), maskBullets: false}));
...
var KTChartsWidget17 = {init: function () {
        !function () {
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t, a = function () {
                        (t = am5.Root.new(e)).setThemes([am5themes_Animated.new(t)]);
                        var a = t.container.children.push(am5percent.PieChart.new(t, {startAngle: 180, endAngle: 360, layout: t.verticalLayout, innerRadius: am5.percent(50)})).series.push(am5percent.PieSeries.new(t, {startAngle: 180, endAngle: 360, valueField: "value", categoryField: "category", alignLabels: false}));
                        a.labels.template.setAll({fontWeight: "400", fontSize: 13, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))}), a.states.create("hidden", {startAngle: 180, endAngle: 180}), a.slices.template.setAll({cornerRadius: 5}), a.ticks.template.setAll({forceHidden: true}), a.data.setAll([{value: 10, category: "One", fill: am5.color(KTUtil.getCssVariableValue("--bs-primary"))}, {value: 9, category: "Two", fill: am5.color(KTUtil.getCssVariableValue("--bs-success"))}, {value: 6, category: "Three", fill: am5.color(KTUtil.getCssVariableValue("--bs-danger"))}, {value: 5, category: "Four", fill: am5.color(KTUtil.getCssVariableValue("--bs-warning"))}, {value: 4, category: "Five", fill: am5.color(KTUtil.getCssVariableValue("--bs-info"))}, {value: 3, category: "Six", fill: am5.color(KTUtil.getCssVariableValue("--bs-secondary"))}]), a.appear(1e3, 100);
                    };
                    am5.ready(function () {
                        a();
                    }), KTThemeMode.on("kt.thememode.change", function () {
...
var KTChartsWidget18 = function () {
    var e = {self: null, rendered: false}, t = function (e) {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-gray-900"), r = KTUtil.getCssVariableValue("--bs-border-dashed-color"), o = {series: [{name: "Spent time", data: [54, 42, 75, 110, 23, 87, 50]}], chart: {fontFamily: "inherit", type: "bar", height: a, toolbar: {show: false}}, plotOptions: {bar: {horizontal: false, columnWidth: ["28%"], borderRadius: 5, dataLabels: {position: "top"}, startingShape: "flat"}}, legend: {show: false}, dataLabels: {enabled: true, offsetY: -28, style: {fontSize: "13px", colors: [l]}, formatter: function (e) {
                        return e;
                    }}, stroke: {show: true, width: 2, colors: ["transparent"]}, xaxis: {categories: ["QA Analysis", "Marketing", "Web Dev", "Maths", "Front-end Dev", "Physics", "Phylosophy"], axisBorder: {show: false}, axisTicks: {show: false}, labels: {style: {colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px"}}, crosshairs: {fill: {gradient: {opacityFrom: 0, opacityTo: 0}}}}, yaxis: {labels: {style: {colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px"}, formatter: function (e) {
                            return e + "H";
                        }}}, fill: {opacity: 1}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, y: {formatter: function (e) {
                            return +e + " hours";
                        }}}, colors: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-primary-light")], grid: {borderColor: r, strokeDashArray: 4, yaxis: {lines: {show: true}}}};
            e.self = new ApexCharts(t, o), setTimeout(function () {
                e.self.render(), e.rendered = true;
            }, 200);
        }
...
var KTChartsWidget19 = {init: function () {
        !function () {
            if ("undefined" != typeof am5) {
            ...
            if ("undefined" != typeof am5) {
                ...
                if (t) {
                    var a = function () {
                        ...
                        var a = e.container.children.push(am5radar.RadarChart.new(e, {panX: false, panY: false, wheelX: "panX", wheelY: "zoomX", innerRadius: am5.percent(20), startAngle: -90, endAngle: 180})), l = [{category: "Research", value: 40, full: 100, columnSettings: {fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-info"))}}, {category: "Marketing", value: 50, full: 100, columnSettings: {fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-danger"))}}, {category: "Distribution", value: 80, full: 100, columnSettings: {fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-primary"))}}, {category: "Human Resources", value: 70, full: 100, columnSettings: {fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-success"))}}];
                        a.set("cursor", am5radar.RadarCursor.new(e, {behavior: "zoomX"})).lineY.set("visible", false);
                        var r = am5radar.AxisRendererCircular.new(e, {});
                        r.labels.template.setAll({radius: 10}), r.grid.template.setAll({forceHidden: true});
                        var o = a.xAxes.push(am5xy.ValueAxis.new(e, {renderer: r, min: 0, max: 100, strictMinMax: true, numberFormat: "#'%'", tooltip: am5.Tooltip.new(e, {})})), i = am5radar.AxisRendererRadial.new(e, {minGridDistance: 20});
                        i.labels.template.setAll({centerX: am5.p100, fontWeight: "500", fontSize: 18, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500")), templateField: "columnSettings"}), i.grid.template.setAll({forceHidden: true});
                        var s = a.yAxes.push(am5xy.CategoryAxis.new(e, {categoryField: "category", renderer: i}));
                        s.data.setAll(l);
                        var n = a.series.push(am5radar.RadarColumnSeries.new(e, {xAxis: o, yAxis: s, clustered: false, valueXField: "full", categoryYField: "category", fill: e.interfaceColors.get("alternativeBackground")}));
                        n.columns.template.setAll({width: am5.p100, fillOpacity: 0.08, strokeOpacity: 0, cornerRadius: 20}), n.data.setAll(l);
                        var d = a.series.push(am5radar.RadarColumnSeries.new(e, {xAxis: o, yAxis: s, clustered: false, valueXField: "value", categoryYField: "category"}));
                        d.columns.template.setAll({width: am5.p100, strokeOpacity: 0, tooltipText: "{category}: {valueX}%", cornerRadius: 20, templateField: "columnSettings"}), d.data.setAll(l), n.appear(1e3), d.appear(1e3), a.appear(1e3, 100);
                    };
                    am5.ready(function () {
                        a();
...
var KTChartsWidget2 = function () {
    var e = {self: null, rendered: false}, t = function () {
        ...
        if (t) {
            var a = t.getAttribute("data-kt-chart-color"), l = parseInt(KTUtil.css(t, "height")), r = KTUtil.getCssVariableValue("--bs-gray-800"), o = KTUtil.getCssVariableValue("--bs-border-dashed-color"), i = KTUtil.getCssVariableValue("--bs-" + a), s = KTUtil.getCssVariableValue("--bs-" + a + "-light"), n = {series: [{name: "Overview", data: [15, 15, 45, 45, 25, 25, 55, 55, 20, 20, 37]}], chart: {fontFamily: "inherit", type: "area", height: l, toolbar: {show: false}, zoom: {enabled: false}, sparkline: {enabled: true}}, plotOptions: {}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "solid", opacity: 1}, stroke: {curve: "smooth", show: true, width: 3, colors: [i]}, xaxis: {categories: ["Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], axisBorder: {show: false}, axisTicks: {show: false}, labels: {show: false, style: {colors: r, fontSize: "12px"}}, crosshairs: {show: false, position: "front", stroke: {color: o, width: 1, dashArray: 3}}, tooltip: {enabled: true, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}}, yaxis: {min: 0, max: 60, labels: {show: false, style: {colors: r, fontSize: "12px"}}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, y: {formatter: function (e) {
                            return e;
                        }}}, colors: [s], markers: {colors: s, strokeColor: i, strokeWidth: 3}};
...
var KTChartsWidget20 = function () {
    var e = {self: null, rendered: false}, t = function (e) {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-gray-500"), r = KTUtil.getCssVariableValue("--bs-border-dashed-color"), o = KTUtil.getCssVariableValue("--bs-danger"), i = KTUtil.getCssVariableValue("--bs-danger"), s = {series: [{name: t.getAttribute("data-kt-chart-info"), data: [34.5, 34.5, 35, 35, 35.5, 35.5, 35, 35, 35.5, 35.5, 35, 35, 34.5, 34.5, 35, 35, 35.4, 35.4, 35]}], chart: {fontFamily: "inherit", type: "area", height: a, toolbar: {show: false}}, plotOptions: {}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "gradient", gradient: {shadeIntensity: 1, opacityFrom: 0.4, opacityTo: 0, stops: [0, 80, 100]}}, stroke: {curve: "smooth", show: true, width: 3, colors: [o]}, xaxis: {categories: ["", "Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 07", "Apr 08", "Apr 09", "Apr 10", "Apr 11", "Apr 12", "Apr 13", "Apr 14", "Apr 17", "Apr 18", "Apr 19", "Apr 21", ""], axisBorder: {show: false}, axisTicks: {show: false}, tickAmount: 6, labels: {rotate: 0, rotateAlways: true, style: {colors: l, fontSize: "12px"}}, crosshairs: {position: "front", stroke: {color: o, width: 1, dashArray: 3}}, tooltip: {enabled: true, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}}, yaxis: {max: 36.3, min: 33, tickAmount: 6, labels: {style: {colors: l, fontSize: "12px"}, formatter: function (e) {
                            return "$" + parseInt(10 * e);
                        }}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, y: {formatter: function (e) {
                            return "$" + parseInt(10 * e);
                        }}}, colors: [i], grid: {borderColor: r, strokeDashArray: 4, yaxis: {lines: {show: true}}}, markers: {strokeColor: o, strokeWidth: 3}};
...
var KTChartsWidget22 = function () {
    var e = function (e, t, a, l) {
        ...
        if (r) {
            ...
            var o = {series: a, chart: {fontFamily: "inherit", type: "donut", width: 250}, plotOptions: {pie: {donut: {size: "50%", labels: {value: {fontSize: "10px"}}}}}, colors: [KTUtil.getCssVariableValue("--bs-info"), KTUtil.getCssVariableValue("--bs-success"), KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-danger")], stroke: {width: 0}, labels: ["Sales", "Sales", "Sales", "Sales"], legend: {show: false}, fill: {type: "false"}}, i = new ApexCharts(r, o), s = false, n = document.querySelector(e);
            true === l && (i.render(), s = true), n.addEventListener("shown.bs.tab", function (e) {
                0 == s && (i.render(), s = true);
            });
        }
    };
    return {init: function () {
            e("#kt_chart_widgets_22_tab_1", "#kt_chart_widgets_22_chart_1", [20, 100, 15, 25], true), e("#kt_chart_widgets_22_tab_2", "#kt_chart_widgets_22_chart_2", [70, 13, 11, 2], false);
        }};
}();
"undefined" != typeof module && (module.exports = KTChartsWidget22), KTUtil.onDOMContentLoaded(function () {
    KTChartsWidget22.init();
});
var KTChartsWidget23 = {init: function () {
        !function () {
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t, a = function () {
                        (t = am5.Root.new(e)).setThemes([am5themes_Animated.new(t)]);
                        var a = t.container.children.push(am5xy.XYChart.new(t, {panX: false, panY: false, layout: t.verticalLayout})), l = [{year: "2016", income: 23.5, expenses: 21.1, columnSettings: {fill: am5.color(KTUtil.getCssVariableValue("--bs-primary"))}}, {year: "2017", income: 26.2, expenses: 30.5, columnSettings: {fill: am5.color(KTUtil.getCssVariableValue("--bs-primary"))}}, {year: "2018", income: 30.1, expenses: 34.9, columnSettings: {fill: am5.color(KTUtil.getCssVariableValue("--bs-primary"))}}, {year: "2019", income: 29.5, expenses: 31.1, columnSettings: {fill: am5.color(KTUtil.getCssVariableValue("--bs-primary"))}}, {year: "2020", income: 30.6, expenses: 28.2, strokeSettings: {strokeWidth: 3, strokeDasharray: [5, 5]}, columnSettings: {fill: am5.color(KTUtil.getCssVariableValue("--bs-primary"))}}, {year: "2021", income: 40.6, expenses: 28.2, strokeSettings: {strokeWidth: 3, strokeDasharray: [5, 5]}, columnSettings: {fill: am5.color(KTUtil.getCssVariableValue("--bs-primary"))}}, {year: "2022", income: 34.1, expenses: 32.9, strokeSettings: {strokeWidth: 3, strokeDasharray: [5, 5]}, columnSettings: {fill: am5.color(KTUtil.getCssVariableValue("--bs-primary"))}}], r = a.xAxes.push(am5xy.CategoryAxis.new(t, {categoryField: "year", renderer: am5xy.AxisRendererX.new(t, {})}));
                        r.data.setAll(l), r.get("renderer").labels.template.setAll({paddingTop: 20, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))}), r.get("renderer").grid.template.setAll({disabled: true, strokeOpacity: 0});
                        var o = a.yAxes.push(am5xy.ValueAxis.new(t, {min: 0, extraMax: 0.1, renderer: am5xy.AxisRendererY.new(t, {})}));
                        o.get("renderer").labels.template.setAll({paddingTop: 0, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))}), o.get("renderer").grid.template.setAll({stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3]});
                        var i = a.series.push(am5xy.ColumnSeries.new(t, {name: "Income", xAxis: r, yAxis: o, valueYField: "income", categoryXField: "year", tooltip: am5.Tooltip.new(t, {pointerOrientation: "horizontal", labelText: "{name} in {categoryX}: {valueY} {info}"})}));
                        i.columns.template.setAll({tooltipY: am5.percent(10), templateField: "columnSettings"}), i.data.setAll(l);
                        var s = a.series.push(am5xy.LineSeries.new(t, {name: "Expenses", xAxis: r, yAxis: o, valueYField: "expenses", categoryXField: "year", fill: am5.color(KTUtil.getCssVariableValue("--bs-success")), stroke: am5.color(KTUtil.getCssVariableValue("--bs-success")), tooltip: am5.Tooltip.new(t, {pointerOrientation: "horizontal", labelText: "{name} in {categoryX}: {valueY} {info}"})}));
                        s.strokes.template.setAll({stroke: am5.color(KTUtil.getCssVariableValue("--bs-success"))}), s.strokes.template.setAll({strokeWidth: 3, templateField: "strokeSettings"}), s.data.setAll(l), s.bullets.push(function () {
                            return am5.Bullet.new(t, {sprite: am5.Circle.new(t, {strokeWidth: 3, stroke: am5.color(KTUtil.getCssVariableValue("--bs-success")), radius: 5, fill: am5.color(KTUtil.getCssVariableValue("--bs-success-light"))})});
                        }), i.columns.template.setAll({strokeOpacity: 0, cornerRadiusBR: 0, cornerRadiusTR: 6, cornerRadiusBL: 0, cornerRadiusTL: 6}), a.set("cursor", am5xy.XYCursor.new(t, {})), a.get("cursor").lineX.setAll({visible: false}), a.get("cursor").lineY.setAll({visible: false});
            ...
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t, a = function () {
                        ...
                        var i = o.children.push(am5xy.XYChart.new(t, {panX: false, panY: false, wheelX: "none", wheelY: "none", layout: t.verticalLayout, width: am5.percent(60)})), s = i.yAxes.push(am5xy.CategoryAxis.new(t, {categoryField: "age", renderer: am5xy.AxisRendererY.new(t, {})}));
                        s.get("renderer").labels.template.setAll({paddingTop: 0, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))}), s.get("renderer").grid.template.setAll({stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3]}), s.data.setAll(a);
                        var n = i.yAxes.push(am5xy.CategoryAxis.new(t, {categoryField: "age", renderer: am5xy.AxisRendererY.new(t, {opposite: true})}));
                        n.get("renderer").grid.template.setAll({stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), strokeWidth: 1, strokeOpacity: 1, strokeDasharray: [3]}), n.get("renderer").labels.template.setAll({paddingTop: 0, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))}), n.data.setAll(a);
                        ...
                        d.get("renderer").labels.template.setAll({paddingTop: 20, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))}), d.get("renderer").grid.template.setAll({disabled: true, strokeOpacity: 0});
                        var m = i.series.push(am5xy.ColumnSeries.new(t, {name: "Males", xAxis: d, yAxis: s, valueXField: "malePercent", categoryYField: "age", fill: am5.color(KTUtil.getCssVariableValue("--bs-success")), clustered: false}));
                        m.columns.template.setAll({tooltipText: "Males, age {categoryY}: {male} ({malePercent.formatNumber('#.0s')}%)", tooltipX: am5.p100, cornerRadiusBR: 4, cornerRadiusTR: 4, cornerRadiusBL: 0, cornerRadiusTL: 0}), m.data.setAll(a);
                        var c = i.series.push(am5xy.ColumnSeries.new(t, {name: "Males", xAxis: d, yAxis: s, valueXField: "femalePercent", categoryYField: "age", fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")), clustered: false}));
                        c.columns.template.setAll({tooltipText: "Males, age {categoryY}: {female} ({femalePercent.formatNumber('#.0s')}%)", tooltipX: am5.p100, cornerRadiusBR: 4, cornerRadiusTR: 4, cornerRadiusBL: 0, cornerRadiusTL: 0}), c.data.setAll(a), i.plotContainer.children.push(am5.Label.new(t, {text: "Males", fontSize: 13, fontWeight: "500", y: 5, x: 5, fill: m.get("fill")})), i.plotContainer.children.push(am5.Label.new(t, {text: "Females", fontSize: 13, fontWeight: "500", y: 5, x: am5.p100, centerX: am5.p100, dx: -5, fill: c.get("fill")}));
                        ...
                        i.getTooltip().set("autoTextColor", false);
                        var f, u = g.children.push(am5.Label.new(t, {text: "United States", fontSize: 14, fontWeight: "500", fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-800")), y: 20, x: am5.p50, centerX: am5.p50})), h = g.series.push(am5map.MapPolygonSeries.new(t, {fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")), geoJSON: am5geodata_usaLow}));
                        h.mapPolygons.template.setAll({tooltipText: "{name}", interactive: true}), h.mapPolygons.template.states.create("hover", {fill: am5.color(KTUtil.getCssVariableValue("--bs-success"))}), h.mapPolygons.template.states.create("active", {fill: am5.color(KTUtil.getCssVariableValue("--bs-success"))}), h.mapPolygons.template.events.on("click", function (e) {
                            f && f.set("active", false), (f = e.target).set("active", true);
...
var KTChartsWidget25 = {init: function () {
        !function () {
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t, a = function () {
                        (t = am5.Root.new(e)).setThemes([am5themes_Animated.new(t)]);
                        var a = t.container.children.push(am5radar.RadarChart.new(t, {panX: false, panY: false, wheelX: "panX", wheelY: "zoomX", innerRadius: am5.percent(40), radius: am5.percent(70), arrangeTooltips: false}));
                        a.set("cursor", am5radar.RadarCursor.new(t, {behavior: "zoomX"})).lineY.set("visible", false);
                        var l = am5radar.AxisRendererCircular.new(t, {minGridDistance: 30});
                        l.labels.template.setAll({textType: "radial", radius: 10, paddingTop: 0, paddingBottom: 0, centerY: am5.p50, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-700"))}), l.grid.template.setAll({location: 0.5, strokeDasharray: [2, 2], stroke: KTUtil.getCssVariableValue("--bs-gray-400")});
                        var r = a.xAxes.push(am5xy.CategoryAxis.new(t, {maxDeviation: 0, categoryField: "name", renderer: l})), o = am5radar.AxisRendererRadial.new(t, {minGridDistance: 30});
                        ...
                        s.strokes.template.setAll({strokeOpacity: 0}), s.fills.template.setAll({visible: true, fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")), fillOpacity: 0.5});
                        var n = a.series.push(am5radar.RadarLineSeries.new(t, {name: "Expense", xAxis: r, yAxis: i, valueYField: "value2", categoryXField: "name", stacked: true, tooltip: am5.Tooltip.new(t, {labelText: "Revenue: {value1}\nExpense:{value2}"}), fill: am5.color(KTUtil.getCssVariableValue("--bs-success"))}));
                        n.strokes.template.setAll({strokeOpacity: 0}), n.fills.template.setAll({visible: true, fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")), fillOpacity: 0.5});
            ...
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t, a = function () {
                        ...
                        var l = am5radar.AxisRendererCircular.new(t, {minGridDistance: 30});
                        l.labels.template.setAll({textType: "radial", radius: 10, paddingTop: 0, paddingBottom: 0, centerY: am5.p50, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-700"))}), l.grid.template.setAll({location: 0.5, strokeDasharray: [2, 2], stroke: KTUtil.getCssVariableValue("--bs-gray-400")});
                        var r = a.xAxes.push(am5xy.CategoryAxis.new(t, {maxDeviation: 0, categoryField: "name", renderer: l})), o = am5radar.AxisRendererRadial.new(t, {minGridDistance: 30}), i = a.yAxes.push(am5xy.ValueAxis.new(t, {renderer: o}));
                        o.grid.template.setAll({strokeDasharray: [2, 2], stroke: KTUtil.getCssVariableValue("--bs-gray-400")}), o.labels.template.setAll({fontWeight: "500", fontSize: 12, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-700"))});
                        var s = a.series.push(am5radar.RadarLineSeries.new(t, {name: "Revenue", xAxis: r, yAxis: i, valueYField: "value1", categoryXField: "name", fill: am5.color(KTUtil.getCssVariableValue("--bs-primary"))}));
                        s.strokes.template.setAll({strokeOpacity: 0}), s.fills.template.setAll({visible: true, fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")), fillOpacity: 0.5});
                        var n = a.series.push(am5radar.RadarLineSeries.new(t, {name: "Expense", xAxis: r, yAxis: i, valueYField: "value2", categoryXField: "name", stacked: true, tooltip: am5.Tooltip.new(t, {labelText: "Revenue: {value1}\nExpense:{value2}"}), fill: am5.color(KTUtil.getCssVariableValue("--bs-success"))}));
                        n.strokes.template.setAll({strokeOpacity: 0}), n.fills.template.setAll({visible: true, fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")), fillOpacity: 0.5});
...
var KTChartsWidget27 = function () {
    var e = {self: null, rendered: false}, t = function (e) {
        ...
        if (t) {
            var a = KTUtil.getCssVariableValue("--bs-gray-800"), l = KTUtil.getCssVariableValue("--bs-border-dashed-color"), r = {series: [{name: "Sessions", data: [12.478, 7.546, 6.083, 5.041, 4.42]}], chart: {fontFamily: "inherit", type: "bar", height: 350, toolbar: {show: false}}, plotOptions: {bar: {borderRadius: 8, horizontal: true, distributed: true, barHeight: 50, dataLabels: {position: "bottom"}}}, dataLabels: {enabled: true, textAnchor: "start", offsetX: 0, formatter: function (e, t) {
                        e *= 1e3;
                        return wNumb({thousand: ","}).to(e);
                    }, style: {fontSize: "14px", fontWeight: "600", align: "left"}}, legend: {show: false}, colors: ["#3E97FF", "#F1416C", "#50CD89", "#FFC700", "#7239EA"], xaxis: {categories: ["USA", "India", "Canada", "Brasil", "France"], labels: {formatter: function (e) {
                            return e + "K";
                        }, style: {colors: a, fontSize: "14px", fontWeight: "600", align: "left"}}, axisBorder: {show: false}}, yaxis: {labels: {formatter: function (e, t) {
                            return Number.isInteger(e) ? e + " - " + parseInt(100 * e / 18).toString() + "%" : e;
                        }, style: {colors: a, fontSize: "14px", fontWeight: "600"}, offsetY: 2, align: "left"}}, grid: {borderColor: l, xaxis: {lines: {show: true}}, yaxis: {lines: {show: false}}, strokeDashArray: 4}, tooltip: {style: {fontSize: "12px"}, y: {formatter: function (e) {
                            return e;
                        }}}};
...
var KTChartsWidget28 = function () {
    var e = {self: null, rendered: false}, t = function (e) {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-gray-500"), r = KTUtil.getCssVariableValue("--bs-border-dashed-color"), o = KTUtil.getCssVariableValue("--bs-info"), i = {series: [{name: "Links", data: [190, 230, 230, 200, 200, 190, 190, 200, 200, 220, 220, 200, 200, 210, 210]}], chart: {fontFamily: "inherit", type: "area", height: a, toolbar: {show: false}}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "gradient", gradient: {shadeIntensity: 1, opacityFrom: 0.4, opacityTo: 0, stops: [0, 80, 100]}}, stroke: {curve: "smooth", show: true, width: 3, colors: [o]}, xaxis: {categories: ["May 04", "May 05", "May 06", "May 09", "May 10", "May 12", "May 14", "May 17", "May 18", "May 20", "May 22", "May 24", "May 26", "May 28", "May 30"], axisBorder: {show: false}, offsetX: 20, axisTicks: {show: false}, tickAmount: 3, labels: {rotate: 0, rotateAlways: false, style: {colors: l, fontSize: "12px"}}, crosshairs: {position: "front", stroke: {color: o, width: 1, dashArray: 3}}, tooltip: {enabled: true, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}}, yaxis: {tickAmount: 4, max: 250, min: 100, labels: {style: {colors: l, fontSize: "12px"}, formatter: function (e) {
                            return e;
                        }}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, y: {formatter: function (e) {
                            return e;
                        }}}, colors: [o], grid: {borderColor: r, strokeDashArray: 4, yaxis: {lines: {show: true}}}, markers: {strokeColor: o, strokeWidth: 3}};
            e.self = new ApexCharts(t, i), setTimeout(function () {
                e.self.render(), e.rendered = true;
            }, 200);
        }
...
var KTChartsWidget29 = function () {
    var e = {self: null, rendered: false}, t = function (e) {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-gray-500"), r = KTUtil.getCssVariableValue("--bs-border-dashed-color"), o = KTUtil.getCssVariableValue("--bs-warning"), i = {series: [{name: "Position", data: [4, 7.5, 7.5, 6, 6, 4, 4, 6, 6, 8, 8, 6, 6, 7, 7]}], chart: {fontFamily: "inherit", type: "area", height: a, toolbar: {show: false}}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "gradient", gradient: {shadeIntensity: 1, opacityFrom: 0.4, opacityTo: 0, stops: [0, 80, 100]}}, stroke: {curve: "smooth", show: true, width: 3, colors: [o]}, xaxis: {categories: ["Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 09", "Apr 10", "Apr 12", "Apr 14", "Apr 17", "Apr 18", "Apr 18", "Apr 20", "Apr 22", "Apr 24"], axisBorder: {show: false}, axisTicks: {show: false}, offsetX: 20, tickAmount: 4, labels: {rotate: 0, rotateAlways: false, style: {colors: l, fontSize: "12px"}}, crosshairs: {position: "front", stroke: {color: o, width: 1, dashArray: 3}}, tooltip: {enabled: true, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}}, yaxis: {tickAmount: 4, max: 10, min: 1, labels: {style: {colors: l, fontSize: "12px"}, formatter: function (e) {
                            return e;
                        }}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, y: {formatter: function (e) {
                            return e;
                        }}}, colors: [o], grid: {borderColor: r, strokeDashArray: 4, yaxis: {lines: {show: true}}}, markers: {strokeColor: o, strokeWidth: 3}};
...
var KTChartsWidget3 = function () {
    var e = {self: null, rendered: false}, t = function (e) {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-gray-500"), r = KTUtil.getCssVariableValue("--bs-border-dashed-color"), o = KTUtil.getCssVariableValue("--bs-success"), i = {series: [{name: "Sales", data: [18, 18, 20, 20, 18, 18, 22, 22, 20, 20, 18, 18, 20, 20, 18, 18, 20, 20, 22]}], chart: {fontFamily: "inherit", type: "area", height: a, toolbar: {show: false}}, plotOptions: {}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "gradient", gradient: {shadeIntensity: 1, opacityFrom: 0.4, opacityTo: 0, stops: [0, 80, 100]}}, stroke: {curve: "smooth", show: true, width: 3, colors: [o]}, xaxis: {categories: ["", "Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 07", "Apr 08", "Apr 09", "Apr 10", "Apr 11", "Apr 12", "Apr 13", "Apr 14", "Apr 15", "Apr 16", "Apr 17", "Apr 18", ""], axisBorder: {show: false}, axisTicks: {show: false}, tickAmount: 6, labels: {rotate: 0, rotateAlways: true, style: {colors: l, fontSize: "12px"}}, crosshairs: {position: "front", stroke: {color: o, width: 1, dashArray: 3}}, tooltip: {enabled: true, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}}, yaxis: {tickAmount: 4, max: 24, min: 10, labels: {style: {colors: l, fontSize: "12px"}, formatter: function (e) {
                            return "$" + e + "K";
                        }}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, y: {formatter: function (e) {
                            return "$" + e + "K";
                        }}}, colors: [KTUtil.getCssVariableValue("--bs-success")], grid: {borderColor: r, strokeDashArray: 4, yaxis: {lines: {show: true}}}, markers: {strokeColor: o, strokeWidth: 3}};
            e.self = new ApexCharts(t, i), setTimeout(function () {
                e.self.render(), e.rendered = true;
            }, 200);
        }
...
var KTChartsWidget30 = {init: function () {
        !function () {
            if ("undefined" != typeof am5) {
...
var KTChartsWidget31 = {init: function () {
        !function () {
            if ("undefined" != typeof am5) {
                var e = document.getElementById("kt_charts_widget_31_chart");
                if (e) {
                    var t, a, l = function () {
                        (a = am5.Root.new(e)).setThemes([am5themes_Animated.new(a)]), (t = a.container.children.push(am5radar.RadarChart.new(a, {panX: false, panY: false, wheelX: "panX", wheelY: "zoomX", innerRadius: am5.percent(40), radius: am5.percent(70), arrangeTooltips: false}))).set("cursor", am5radar.RadarCursor.new(a, {behavior: "zoomX"})).lineY.set("visible", false);
                        var l = am5radar.AxisRendererCircular.new(a, {minGridDistance: 30});
                        l.labels.template.setAll({textType: "radial", radius: 10, paddingTop: 0, paddingBottom: 0, centerY: am5.p50, fontWeight: "400", fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-800"))}), l.grid.template.setAll({location: 0.5, strokeDasharray: [2, 2], stroke: KTUtil.getCssVariableValue("--bs-gray-400")});
                        var r = t.xAxes.push(am5xy.CategoryAxis.new(a, {maxDeviation: 0, categoryField: "name", renderer: l})), o = am5radar.AxisRendererRadial.new(a, {minGridDistance: 30});
                        o.labels.template.setAll({fontWeight: "500", fontSize: 12, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-700"))});
                        ...
                        s.strokes.template.setAll({strokeOpacity: 0}), s.fills.template.setAll({visible: true, fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")), fillOpacity: 0.5});
                        var n = t.series.push(am5radar.RadarLineSeries.new(a, {name: "Expense", xAxis: r, yAxis: i, valueYField: "value2", categoryXField: "name", stacked: true, tooltip: am5.Tooltip.new(a, {labelText: "Revenue: {value1}\nExpense:{value2}"}), fill: am5.color(KTUtil.getCssVariableValue("--bs-success"))}));
                        n.strokes.template.setAll({strokeOpacity: 0}), n.fills.template.setAll({visible: true, fill: am5.color(KTUtil.getCssVariableValue("--bs-primary")), fillOpacity: 0.5});
...
var KTChartsWidget32 = function () {
    var e = {self: null, rendered: false}, t = {self: null, rendered: false}, a = {self: null, rendered: false}, l = function (e, t, a, l, r) {
        var o = document.querySelector(a);
        if (o) {
            var i = parseInt(KTUtil.css(o, "height")), s = KTUtil.getCssVariableValue("--bs-gray-900"), n = KTUtil.getCssVariableValue("--bs-border-dashed-color"), d = {series: [{name: "Deliveries", data: l}], chart: {fontFamily: "inherit", type: "bar", height: i, toolbar: {show: false}}, plotOptions: {bar: {horizontal: false, columnWidth: ["22%"], borderRadius: 5, dataLabels: {position: "top"}, startingShape: "flat"}}, legend: {show: false}, dataLabels: {enabled: true, offsetY: -28, style: {fontSize: "13px", colors: [s]}}, stroke: {show: true, width: 2, colors: ["transparent"]}, xaxis: {categories: ["Grossey", "Pet Food", "Flowers", "Restaurant", "Kids Toys", "Clothing", "Still Water"], axisBorder: {show: false}, axisTicks: {show: false}, labels: {style: {colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px"}}, crosshairs: {fill: {gradient: {opacityFrom: 0, opacityTo: 0}}}}, yaxis: {labels: {style: {colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px"}}}, fill: {opacity: 1}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}}, colors: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-primary-light")], grid: {borderColor: n, strokeDashArray: 4, yaxis: {lines: {show: true}}}};
            e.self = new ApexCharts(o, d);
            var m = document.querySelector(t);
            true === r && setTimeout(function () {
                e.self.render(), e.rendered = true;
    ...
    return {init: function () {
            ...
            l(e, "#kt_charts_widget_32_tab_1", "#kt_charts_widget_32_chart_1", r, true);
            var o = [25, 55, 35, 50, 45, 20, 31];
            l(t, "#kt_charts_widget_32_tab_2", "#kt_charts_widget_32_chart_2", o, false);
            var i = [45, 15, 35, 70, 45, 50, 21];
            l(a, "#kt_charts_widget_32_tab_3", "#kt_charts_widget_32_chart_3", i, false), KTThemeMode.on("kt.thememode.change", function () {
...
var KTChartsWidget33 = function () {
    var e = {self: null, rendered: false}, t = {self: null, rendered: false}, a = {self: null, rendered: false}, l = {self: null, rendered: false}, r = {self: null, rendered: false}, o = function (e, t, a, l, r, o) {
        var i = document.querySelector(a);
        if (i) {
            var s = i.getAttribute("data-kt-chart-color"), n = parseInt(KTUtil.css(i, "height")), d = KTUtil.getCssVariableValue("--bs-gray-500"), m = KTUtil.getCssVariableValue("--bs-border-dashed-color"), c = KTUtil.getCssVariableValue("--bs-" + s), g = {series: [{name: "Etherium ", data: l}], chart: {fontFamily: "inherit", type: "area", height: n, toolbar: {show: false}}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "gradient", gradient: {shadeIntensity: 1, opacityFrom: 0.4, opacityTo: 0.2, stops: [15, 120, 100]}}, stroke: {curve: "smooth", show: true, width: 3, colors: [c]}, xaxis: {categories: r, axisBorder: {show: false}, axisTicks: {show: false}, offsetX: 20, tickAmount: 4, labels: {rotate: 0, rotateAlways: false, show: false, style: {colors: d, fontSize: "12px"}}, crosshairs: {position: "front", stroke: {color: c, width: 1, dashArray: 3}}, tooltip: {enabled: true, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}}, yaxis: {tickAmount: 4, max: 4e3, min: 1e3, labels: {show: false}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, y: {formatter: function (e) {
                            return e + "$";
                        }}}, colors: [c], grid: {borderColor: m, strokeDashArray: 3, yaxis: {lines: {show: true}}}, markers: {strokeColor: c, strokeWidth: 3}};
            e.self = new ApexCharts(i, g);
            var f = document.querySelector(t);
            true === o && setTimeout(function () {
                e.self.render(), e.rendered = true;
    ...
    return {init: function () {
            var i = [2100, 3200, 3200, 2400, 2400, 1800, 1800, 2400, 2400, 3200, 3200, 3e3, 3e3, 3250, 3250], s = ["10AM", "10.30AM", "11AM", "11.15AM", "11.30AM", "12PM", "1PM", "2PM", "3PM", "4PM", "5PM", "6PM", "7PM", "8PM", "9PM"];
            o(e, "#kt_charts_widget_33_tab_1", "#kt_charts_widget_33_chart_1", i, s, true);
            var n = [2300, 2300, 2e3, 3200, 3200, 2800, 2400, 2400, 3100, 2900, 3100, 3100, 2600, 2600, 3200], d = ["Apr 01", "Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 07", "Apr 08", "Apr 09", "Apr 10", "Apr 11", "Apr 12", "Apr 13", "Apr 14", "Apr 15"];
            o(t, "#kt_charts_widget_33_tab_2", "#kt_charts_widget_33_chart_2", n, d, false);
            var m = [2600, 3200, 2300, 2300, 2e3, 3200, 3100, 2900, 3200, 3200, 2600, 3100, 2800, 2400, 2400], c = ["Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 09", "Apr 10", "Apr 12", "Apr 14", "Apr 17", "Apr 18", "Apr 18", "Apr 20", "Apr 22", "Apr 24"];
            o(a, "#kt_charts_widget_33_tab_3", "#kt_charts_widget_33_chart_3", m, c, false);
            var g = [1800, 1800, 2400, 2400, 3200, 3200, 3e3, 2100, 3200, 3300, 2400, 2400, 3e3, 3200, 3100], f = ["Jun 2021", "Jul 2021", "Aug 2021", "Sep 2021", "Oct 2021", "Nov 2021", "Dec 2021", "Jan 2022", "Feb 2022", "Mar 2022", "Apr 2022", "May 2022", "Jun 2022", "Jul 2022", "Aug 2022"];
            o(l, "#kt_charts_widget_33_tab_4", "#kt_charts_widget_33_chart_4", g, f, false);
            var u = [3e3, 2100, 3300, 3100, 1800, 1800, 2400, 2400, 3100, 3100, 2400, 2400, 3e3, 2400, 2800], h = ["Sep 2021", "Oct 2021", "Nov 2021", "Dec 2021", "Jan 2022", "Feb 2022", "Mar 2022", "Apr 2022", "May 2022", "Jun 2022", "Jul 2022", "Aug 2022", "Sep 2022", "Oct 2022", "Nov 2022"];
            o(r, "#kt_charts_widget_33_tab_5", "#kt_charts_widget_33_chart_5", u, h, false), KTThemeMode.on("kt.thememode.change", function () {
...
var KTChartsWidget34 = function () {
    var e = {self: null, rendered: false}, t = {self: null, rendered: false}, a = {self: null, rendered: false}, l = {self: null, rendered: false}, r = {self: null, rendered: false}, o = function (e, t, a, l, r, o) {
        var i = document.querySelector(a);
        if (i) {
            var s = parseInt(KTUtil.css(i, "height")), n = i.getAttribute("data-kt-chart-color"), d = KTUtil.getCssVariableValue("--bs-gray-500"), m = KTUtil.getCssVariableValue("--bs-border-dashed-color"), c = KTUtil.getCssVariableValue("--bs-" + n), g = {series: [{name: "Earnings", data: l}], chart: {fontFamily: "inherit", type: "area", height: s, toolbar: {show: false}}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "gradient", gradient: {shadeIntensity: 1, opacityFrom: 0.4, opacityTo: 0.2, stops: [15, 120, 100]}}, stroke: {curve: "smooth", show: true, width: 3, colors: [c]}, xaxis: {categories: r, axisBorder: {show: false}, axisTicks: {show: false}, offsetX: 20, tickAmount: 4, labels: {rotate: 0, rotateAlways: false, show: false, style: {colors: d, fontSize: "12px"}}, crosshairs: {position: "front", stroke: {color: c, width: 1, dashArray: 3}}, tooltip: {enabled: true, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}}, yaxis: {tickAmount: 4, max: 4e3, min: 1e3, labels: {show: false}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, y: {formatter: function (e) {
                            return e + "$";
                        }}}, colors: [c], grid: {borderColor: m, strokeDashArray: 3, yaxis: {lines: {show: true}}}, markers: {strokeColor: c, strokeWidth: 3}};
            e.self = new ApexCharts(i, g);
            var f = document.querySelector(t);
    ...
    return {init: function () {
            var i = [2100, 2800, 2800, 2400, 2400, 1800, 1800, 2400, 2400, 3200, 3200, 2800, 2800, 3250, 3250], s = ["10AM", "10.30AM", "11AM", "11.15AM", "11.30AM", "12PM", "1PM", "2PM", "3PM", "4PM", "5PM", "6PM", "7PM", "8PM", "9PM"];
            o(e, "#kt_charts_widget_34_tab_1", "#kt_charts_widget_34_chart_1", i, s, true);
            var n = [2300, 2300, 2e3, 3100, 3100, 2800, 2400, 2400, 3100, 2900, 3200, 3200, 2600, 2600, 3200], d = ["Apr 01", "Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 07", "Apr 08", "Apr 09", "Apr 10", "Apr 11", "Apr 12", "Apr 13", "Apr 14", "Apr 15"];
            o(t, "#kt_charts_widget_34_tab_2", "#kt_charts_widget_34_chart_2", n, d, false);
            var m = [2600, 3400, 2300, 2300, 2e3, 3100, 3100, 2900, 3200, 3200, 2600, 3100, 2800, 2400, 2400], c = ["Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 09", "Apr 10", "Apr 12", "Apr 14", "Apr 17", "Apr 18", "Apr 18", "Apr 20", "Apr 22", "Apr 24"];
            o(a, "#kt_charts_widget_34_tab_3", "#kt_charts_widget_34_chart_3", m, c, false);
            var g = [1800, 1800, 2400, 2400, 3100, 3100, 3e3, 2100, 3200, 3200, 2400, 2400, 3e3, 3200, 3100], f = ["Jun 2021", "Jul 2021", "Aug 2021", "Sep 2021", "Oct 2021", "Nov 2021", "Dec 2021", "Jan 2022", "Feb 2022", "Mar 2022", "Apr 2022", "May 2022", "Jun 2022", "Jul 2022", "Aug 2022"];
            o(l, "#kt_charts_widget_34_tab_4", "#kt_charts_widget_34_chart_4", g, f, false);
            var u = [3e3, 2100, 3200, 3200, 1800, 1800, 2400, 2400, 3100, 3100, 2400, 2400, 3e3, 2400, 2800], h = ["Sep 2021", "Oct 2021", "Nov 2021", "Dec 2021", "Jan 2022", "Feb 2022", "Mar 2022", "Apr 2022", "May 2022", "Jun 2022", "Jul 2022", "Aug 2022", "Sep 2022", "Oct 2022", "Nov 2022"];
            o(r, "#kt_charts_widget_34_tab_5", "#kt_charts_widget_34_chart_5", u, h, false), KTThemeMode.on("kt.thememode.change", function () {
...
var KTChartsWidget35 = function () {
    ...
    return {init: function () {
            var i = [2100, 3100, 3100, 2400, 2400, 1800, 1800, 2400, 2400, 3200, 3200, 2800, 2800, 3250, 3250], s = ["10AM", "10.30AM", "11AM", "11.15AM", "11.30AM", "12PM", "1PM", "2PM", "3PM", "4PM", "5PM", "6PM", "7PM", "8PM", "9PM"];
            o(e, "#kt_charts_widget_35_tab_1", "#kt_charts_widget_35_chart_1", i, s, true);
            var n = [2300, 2300, 2e3, 3200, 3200, 2800, 2400, 2400, 3100, 2900, 3200, 3200, 2600, 2600, 3200], d = ["Apr 01", "Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 07", "Apr 08", "Apr 09", "Apr 10", "Apr 11", "Apr 12", "Apr 13", "Apr 14", "Apr 15"];
            o(t, "#kt_charts_widget_35_tab_2", "#kt_charts_widget_35_chart_2", n, d, false);
            var m = [2600, 3200, 2300, 2300, 2e3, 3200, 3100, 2900, 3400, 3400, 2600, 3200, 2800, 2400, 2400], c = ["Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 09", "Apr 10", "Apr 12", "Apr 14", "Apr 17", "Apr 18", "Apr 18", "Apr 20", "Apr 22", "Apr 24"];
            o(a, "#kt_charts_widget_35_tab_3", "#kt_charts_widget_35_chart_3", m, c, false);
            var g = [1800, 1800, 2400, 2400, 3200, 3200, 3e3, 2100, 3200, 3200, 2400, 2400, 3e3, 3200, 3100], f = ["Jun 2021", "Jul 2021", "Aug 2021", "Sep 2021", "Oct 2021", "Nov 2021", "Dec 2021", "Jan 2022", "Feb 2022", "Mar 2022", "Apr 2022", "May 2022", "Jun 2022", "Jul 2022", "Aug 2022"];
            o(l, "#kt_charts_widget_35_tab_4", "#kt_charts_widget_35_chart_4", g, f, false);
            var u = [3200, 2100, 3200, 3200, 3200, 3500, 3e3, 2400, 3250, 2400, 2400, 3250, 3e3, 2400, 2800], h = ["Sep 2021", "Oct 2021", "Nov 2021", "Dec 2021", "Jan 2022", "Feb 2022", "Mar 2022", "Apr 2022", "May 2022", "Jun 2022", "Jul 2022", "Aug 2022", "Sep 2022", "Oct 2022", "Nov 2022"];
            o(r, "#kt_charts_widget_35_tab_5", "#kt_charts_widget_35_chart_5", u, h, false), KTThemeMode.on("kt.thememode.change", function () {
...
var KTChartsWidget36 = function () {
    var e = {self: null, rendered: false}, t = function (e) {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-gray-500"), r = KTUtil.getCssVariableValue("--bs-border-dashed-color"), o = KTUtil.getCssVariableValue("--bs-primary"), i = KTUtil.getCssVariableValue("--bs-primary"), s = KTUtil.getCssVariableValue("--bs-success"), n = {series: [{name: "Inbound Calls", data: [65, 80, 80, 60, 60, 45, 45, 80, 80, 70, 70, 90, 90, 80, 80, 80, 60, 60, 50]}, {name: "Outbound Calls", data: [90, 110, 110, 95, 95, 85, 85, 95, 95, 115, 115, 100, 100, 115, 115, 95, 95, 85, 85]}], chart: {fontFamily: "inherit", type: "area", height: a, toolbar: {show: false}}, plotOptions: {}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "gradient", gradient: {shadeIntensity: 1, opacityFrom: 0.4, opacityTo: 0.2, stops: [15, 120, 100]}}, stroke: {curve: "smooth", show: true, width: 3, colors: [o, s]}, xaxis: {categories: ["", "8 AM", "81 AM", "9 AM", "10 AM", "11 AM", "12 PM", "13 PM", "14 PM", "15 PM", "16 PM", "17 PM", "18 PM", "18:20 PM", "18:20 PM", "19 PM", "20 PM", "21 PM", ""], axisBorder: {show: false}, axisTicks: {show: false}, tickAmount: 6, labels: {rotate: 0, rotateAlways: true, style: {colors: l, fontSize: "12px"}}, crosshairs: {position: "front", stroke: {color: [o, s], width: 1, dashArray: 3}}, tooltip: {enabled: true, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}}, yaxis: {max: 120, min: 30, tickAmount: 6, labels: {style: {colors: l, fontSize: "12px"}}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}}, colors: [i, KTUtil.getCssVariableValue("--bs-success")], grid: {borderColor: r, strokeDashArray: 4, yaxis: {lines: {show: true}}}, markers: {strokeColor: [o, s], strokeWidth: 3}};
            e.self = new ApexCharts(t, n), setTimeout(function () {
                e.self.render(), e.rendered = true;
            }, 200);
        }
...
var KTChartsWidget37 = function () {
    var e = {self: null, rendered: false}, t = {self: null, rendered: false}, a = {self: null, rendered: false}, l = {self: null, rendered: false}, r = function (e, t, a, l, r, o) {
        var i = document.querySelector(a);
        if (i) {
            var s = parseInt(KTUtil.css(i, "height")), n = i.getAttribute("data-kt-chart-color"), d = KTUtil.getCssVariableValue("--bs-gray-500"), m = KTUtil.getCssVariableValue("--bs-border-dashed-color"), c = KTUtil.getCssVariableValue("--bs-" + n), g = {series: [{name: "Earnings", data: l}], chart: {fontFamily: "inherit", type: "area", height: s, toolbar: {show: false}}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "gradient", gradient: {shadeIntensity: 1, opacityFrom: 0.4, opacityTo: 0.2, stops: [15, 120, 100]}}, stroke: {curve: "smooth", show: true, width: 3, colors: [c]}, xaxis: {categories: r, axisBorder: {show: false}, axisTicks: {show: false}, offsetX: 20, tickAmount: 4, labels: {rotate: 0, rotateAlways: false, show: false, style: {colors: d, fontSize: "12px"}}, crosshairs: {position: "front", stroke: {color: c, width: 1, dashArray: 3}}, tooltip: {enabled: true, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}}, yaxis: {tickAmount: 4, max: 4e3, min: 1e3, labels: {show: false}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, y: {formatter: function (e) {
                            return e + "$";
    ...
    return {init: function () {
            var o = [2100, 3200, 3200, 2400, 2400, 1800, 1800, 2400, 2400, 3200, 3200, 3e3, 3e3, 3250, 3250], i = ["10AM", "10.30AM", "11AM", "11.15AM", "11.30AM", "12PM", "1PM", "2PM", "3PM", "4PM", "5PM", "6PM", "7PM", "8PM", "9PM"];
            r(e, "#kt_charts_widget_37_tab_1", "#kt_charts_widget_37_chart_1", o, i, true);
            var s = [2300, 2300, 2e3, 3200, 3200, 2800, 2400, 2400, 3100, 2900, 3100, 3100, 2600, 2600, 3200], n = ["Apr 01", "Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 07", "Apr 08", "Apr 09", "Apr 10", "Apr 11", "Apr 12", "Apr 13", "Apr 14", "Apr 15"];
            r(t, "#kt_charts_widget_37_tab_2", "#kt_charts_widget_37_chart_2", s, n, false);
            var d = [2600, 3200, 2300, 2300, 2e3, 3200, 3100, 2900, 3200, 3200, 2600, 3100, 2800, 2400, 2400], m = ["Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 09", "Apr 10", "Apr 12", "Apr 14", "Apr 17", "Apr 18", "Apr 18", "Apr 20", "Apr 22", "Apr 24"];
            r(a, "#kt_charts_widget_37_tab_3", "#kt_charts_widget_37_chart_3", d, m, false);
            var c = [1800, 1800, 2400, 2400, 3200, 3200, 3e3, 2100, 3200, 3300, 2400, 2400, 3e3, 3200, 3100], g = ["Jun 2021", "Jul 2021", "Aug 2021", "Sep 2021", "Oct 2021", "Nov 2021", "Dec 2021", "Jan 2022", "Feb 2022", "Mar 2022", "Apr 2022", "May 2022", "Jun 2022", "Jul 2022", "Aug 2022"];
            r(l, "#kt_charts_widget_37_tab_4", "#kt_charts_widget_37_chart_4", c, g, false), KTThemeMode.on("kt.thememode.change", function () {
...
var KTChartsWidget38 = function () {
    var e = {self: null, rendered: false}, t = function () {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-gray-900"), r = KTUtil.getCssVariableValue("--bs-border-dashed-color"), o = {series: [{name: "LOI Issued", data: [54, 42, 75, 110, 23, 87, 50]}], chart: {fontFamily: "inherit", type: "bar", height: a, toolbar: {show: false}}, plotOptions: {bar: {horizontal: false, columnWidth: ["28%"], borderRadius: 5, dataLabels: {position: "top"}, startingShape: "flat"}}, legend: {show: false}, dataLabels: {enabled: true, offsetY: -28, style: {fontSize: "13px", colors: [l]}, formatter: function (e) {
                        return e;
                    }}, stroke: {show: true, width: 2, colors: ["transparent"]}, xaxis: {categories: ["E2E", "IMC", "SSMC", "SSBD", "ICCD", "PAN", "SBN"], axisBorder: {show: false}, axisTicks: {show: false}, labels: {style: {colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px"}}, crosshairs: {fill: {gradient: {opacityFrom: 0, opacityTo: 0}}}}, yaxis: {labels: {style: {colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px"}, formatter: function (e) {
                            return e + "M";
                        }}}, fill: {opacity: 1}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, y: {formatter: function (e) {
                            return +e + "M";
                        }}}, colors: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-primary-light")], grid: {borderColor: r, strokeDashArray: 4, yaxis: {lines: {show: true}}}};
...
var KTChartsWidget39 = {init: function () {
        !function () {
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t, a = function () {
                        if (t = am5.Root.new(e)) {
                            t.setThemes([am5themes_Animated.new(t)]);
                            var a = t.container.children.push(am5radar.RadarChart.new(t, {panX: false, panY: false, wheelX: "panX", wheelY: "zoomX"})), l = am5radar.AxisRendererCircular.new(t, {});
                            ...
                            var o = a.xAxes.push(am5xy.CategoryAxis.new(t, {maxDeviation: 0, categoryField: "category", renderer: l, tooltip: am5.Tooltip.new(t, {})})), i = a.yAxes.push(am5xy.ValueAxis.new(t, {min: 0, max: 10, renderer: r}));
                            l.labels.template.setAll({fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-800"))}), r.labels.template.setAll({fontSize: 11, fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-800"))});
    ...
    var e = {self: null, rendered: false}, t = function () {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-gray-500"), r = KTUtil.getCssVariableValue("--bs-border-dashed-color"), o = KTUtil.getCssVariableValue("--bs-primary"), i = {series: [{name: "Sales", data: [34.5, 34.5, 35, 35, 35.5, 35.5, 35, 35, 35.5, 35.5, 35, 35, 34.5, 34.5, 35, 35, 35.5, 35.5, 35]}], chart: {fontFamily: "inherit", type: "area", height: a, toolbar: {show: false}}, plotOptions: {}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "gradient", gradient: {shadeIntensity: 1, opacityFrom: 0.4, opacityTo: 0, stops: [0, 80, 100]}}, stroke: {curve: "smooth", show: true, width: 3, colors: [o]}, xaxis: {categories: ["", "Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 07", "Apr 08", "Apr 09", "Apr 10", "Apr 11", "Apr 12", "Apr 13", "Apr 14", "Apr 17", "Apr 18", "Apr 19", "Apr 21", ""], axisBorder: {show: false}, axisTicks: {show: false}, tickAmount: 6, labels: {rotate: 0, rotateAlways: true, style: {colors: l, fontSize: "12px"}}, crosshairs: {position: "front", stroke: {color: o, width: 1, dashArray: 3}}, tooltip: {enabled: true, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}}, yaxis: {max: 36.3, min: 33, tickAmount: 6, labels: {style: {colors: l, fontSize: "12px"}, formatter: function (e) {
                            ...
                            return "$" + parseInt(10 * e);
                        }}}, colors: [KTUtil.getCssVariableValue("--bs-primary")], grid: {borderColor: r, strokeDashArray: 4, yaxis: {lines: {show: true}}}, markers: {strokeColor: o, strokeWidth: 3}};
            e.self = new ApexCharts(t, i), setTimeout(function () {
                e.self.render(), e.rendered = true;
            }, 200);
        }
...
var KTChartsWidget40 = {init: function () {
        !function () {
            if ("undefined" != typeof am5) {
...
var KTChartsWidget41 = function () {
    ...
    return {init: function () {
            var i = [2100, 3100, 3100, 2400, 2400, 1800, 1800, 2400, 2400, 3200, 3200, 2800, 2800, 3250, 3250], s = ["10AM", "10.30AM", "11AM", "11.15AM", "11.30AM", "12PM", "1PM", "2PM", "3PM", "4PM", "5PM", "6PM", "7PM", "8PM", "9PM"];
            o(e, "#kt_charts_widget_41_tab_1", "#kt_charts_widget_41_chart_1", i, s, true);
            var n = [2300, 2300, 2e3, 3200, 3200, 2800, 2400, 2400, 3100, 2900, 3200, 3200, 2600, 2600, 3200], d = ["Apr 01", "Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 07", "Apr 08", "Apr 09", "Apr 10", "Apr 11", "Apr 12", "Apr 13", "Apr 14", "Apr 15"];
            o(t, "#kt_charts_widget_41_tab_2", "#kt_charts_widget_41_chart_2", n, d, false);
            var m = [2600, 3200, 2300, 2300, 2e3, 3200, 3100, 2900, 3400, 3400, 2600, 3200, 2800, 2400, 2400], c = ["Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 09", "Apr 10", "Apr 12", "Apr 14", "Apr 17", "Apr 18", "Apr 18", "Apr 20", "Apr 22", "Apr 24"];
            o(a, "#kt_charts_widget_41_tab_3", "#kt_charts_widget_41_chart_3", m, c, false);
            var g = [1800, 1800, 2400, 2400, 3200, 3200, 3e3, 2100, 3200, 3200, 2400, 2400, 3e3, 3200, 3100], f = ["Jun 2021", "Jul 2021", "Aug 2021", "Sep 2021", "Oct 2021", "Nov 2021", "Dec 2021", "Jan 2022", "Feb 2022", "Mar 2022", "Apr 2022", "May 2022", "Jun 2022", "Jul 2022", "Aug 2022"];
            o(l, "#kt_charts_widget_41_tab_4", "#kt_charts_widget_41_chart_4", g, f, false);
            var u = [3200, 2100, 3200, 3200, 3200, 3500, 3e3, 2400, 3250, 2400, 2400, 3250, 3e3, 2400, 2800], h = ["Sep 2021", "Oct 2021", "Nov 2021", "Dec 2021", "Jan 2022", "Feb 2022", "Mar 2022", "Apr 2022", "May 2022", "Jun 2022", "Jul 2022", "Aug 2022", "Sep 2022", "Oct 2022", "Nov 2022"];
            o(r, "#kt_charts_widget_41_tab_5", "#kt_charts_widget_41_chart_5", u, h, false), KTThemeMode.on("kt.thememode.change", function () {
...
var KTChartsWidget42 = function () {
    var e = {self: null, rendered: false}, t = function (e) {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-gray-500"), r = KTUtil.getCssVariableValue("--bs-border-dashed-color"), o = KTUtil.getCssVariableValue("--bs-primary"), i = KTUtil.getCssVariableValue("--bs-success"), s = {series: [{name: "Inbound Calls", data: [45, 80, 53, 80, 75, 100, 76, 117, 76, 110, 70, 112]}], chart: {fontFamily: "inherit", type: "area", height: a, toolbar: {show: false}}, plotOptions: {}, legend: {show: false}, dataLabels: {enabled: false}, stroke: {curve: "smooth", show: true, width: 3, colors: [o, i]}, xaxis: {categories: ["", "29 Sep", "1 Aug", "2 Aug", "3 Aug", "4 Aug", "5 Aug", "6 Aug", "7 Aug", "8 Aug", "9 Aug", "10 Aug", "11 Aug", "12 Aug", "13 Aug", "14 Aug", "15 Aug", "16 Aug", ""], axisBorder: {show: false}, axisTicks: {show: false}, tickAmount: 6, labels: {rotate: 0, rotateAlways: true, style: {colors: l, fontSize: "12px"}}, crosshairs: {position: "front", stroke: {color: [o, i], width: 1, dashArray: 3}}, tooltip: {enabled: true, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}}, yaxis: {max: 120, min: 30, tickAmount: 6, labels: {style: {colors: l, fontSize: "12px"}}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}}, colors: [o, i], grid: {borderColor: r, strokeDashArray: 4, yaxis: {lines: {show: true}}}, markers: {strokeColor: [o, i], strokeWidth: 3}};
            e.self = new ApexCharts(t, s), setTimeout(function () {
                e.self.render(), e.rendered = true;
            }, 200);
        }
...
var KTChartsWidget44 = function () {
    var e = {self: null, rendered: false}, t = function () {
        ...
        if (t) {
            var a = t.getAttribute("data-kt-chart-color"), l = parseInt(KTUtil.css(t, "height")), r = KTUtil.getCssVariableValue("--bs-gray-800"), o = KTUtil.getCssVariableValue("--bs-border-dashed-color"), i = KTUtil.getCssVariableValue("--bs-" + a), s = KTUtil.getCssVariableValue("--bs-" + a + "-light"), n = {series: [{name: "Overview", data: [20, 37, 22, 45, 20, 50, 25, 57, 40]}], chart: {fontFamily: "inherit", type: "area", height: l, toolbar: {show: false}, zoom: {enabled: false}, sparkline: {enabled: true}}, plotOptions: {}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "solid", opacity: 1}, stroke: {curve: "smooth", show: true, width: 3, colors: [i]}, xaxis: {categories: ["Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], axisBorder: {show: false}, axisTicks: {show: false}, labels: {show: false, style: {colors: r, fontSize: "12px"}}, crosshairs: {show: false, position: "front", stroke: {color: o, width: 1, dashArray: 3}}, tooltip: {enabled: true, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}}, yaxis: {min: 0, max: 60, labels: {show: false, style: {colors: r, fontSize: "12px"}}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, y: {formatter: function (e) {
                            return e;
                        }}}, colors: [s], markers: {colors: s, strokeColor: i, strokeWidth: 3}};
            e.self = new ApexCharts(t, n), setTimeout(function () {
                e.self.render(), e.rendered = true;
...
var KTChartsWidget47 = function () {
    var e = {self: null, rendered: false}, t = function (e) {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-white"), r = {series: [{name: "Sales", data: [5, 5, 15, 15, 19, 16, 27, 24, 34, 25, 40, 30, 19, 17, 22, 10, 14, 14]}], chart: {fontFamily: "inherit", type: "area", height: a, toolbar: {show: false}}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "gradient", gradient: {shadeIntensity: 1, opacityFrom: 0.5, opacityTo: 0, stops: [0, 80, 100]}}, stroke: {curve: "smooth", show: true, width: 2, colors: [l]}, xaxis: {axisBorder: {show: false}, axisTicks: {show: false}, labels: {show: false}, crosshairs: {position: "front", stroke: {color: l, width: 1, dashArray: 3}}, tooltip: {enabled: false}}, yaxis: {labels: {show: false}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {enabled: false}, colors: [KTUtil.getCssVariableValue("--bs-white")], grid: {yaxis: {lines: {show: false}}}, markers: {strokeColor: l, strokeWidth: 2}};
            e.self = new ApexCharts(t, r), setTimeout(function () {
                e.self.render(), e.rendered = true;
            }, 200);
        }
...
var KTChartsWidget48 = function () {
    var e = {self: null, rendered: false}, t = function (e) {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-danger"), r = {series: [{name: "Sales", data: [5, 5, 15, 15, 19, 16, 27, 24, 34, 25, 40, 30, 19, 17, 22, 10, 14, 14]}], chart: {fontFamily: "inherit", type: "area", height: a, toolbar: {show: false}}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "gradient", gradient: {shadeIntensity: 1, opacityFrom: 0.5, opacityTo: 0, stops: [0, 120, 50]}}, stroke: {curve: "smooth", show: true, width: 2, colors: [l]}, xaxis: {axisBorder: {show: false}, axisTicks: {show: false}, labels: {show: false}, crosshairs: {position: "front", stroke: {color: l, width: 1, dashArray: 3}}, tooltip: {enabled: false}}, yaxis: {labels: {show: false}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {enabled: false}, colors: [KTUtil.getCssVariableValue("--bs-danger")], grid: {yaxis: {lines: {show: false}}}, markers: {strokeColor: l, strokeWidth: 2}};
            e.self = new ApexCharts(t, r), setTimeout(function () {
                e.self.render(), e.rendered = true;
            }, 200);
        }
...
var KTChartsWidget5 = function () {
    var e = {self: null, rendered: false}, t = function (e) {
        ...
        if (t) {
            var a = KTUtil.getCssVariableValue("--bs-border-dashed-color"), l = {series: [{data: [15, 12, 10, 8, 7, 4, 3], show: false}], chart: {type: "bar", height: 350, toolbar: {show: false}}, plotOptions: {bar: {borderRadius: 4, horizontal: true, distributed: true, barHeight: 23}}, dataLabels: {enabled: false}, legend: {show: false}, colors: ["#3E97FF", "#F1416C", "#50CD89", "#FFC700", "#7239EA", "#50CDCD", "#3F4254"], xaxis: {categories: ["Phones", "Laptops", "Headsets", "Games", "Keyboardsy", "Monitors", "Speakers"], labels: {formatter: function (e) {
                            return e + "K";
                        }, style: {colors: KTUtil.getCssVariableValue("--bs-gray-400"), fontSize: "14px", fontWeight: "600", align: "left"}}, axisBorder: {show: false}}, yaxis: {labels: {style: {colors: KTUtil.getCssVariableValue("--bs-gray-800"), fontSize: "14px", fontWeight: "600"}, offsetY: 2, align: "left"}}, grid: {borderColor: a, xaxis: {lines: {show: true}}, yaxis: {lines: {show: false}}, strokeDashArray: 4}};
    ...
    var e = {self: null, rendered: false}, t = function (e) {
        ...
        if (t) {
            var a = KTUtil.getCssVariableValue("--bs-gray-800"), l = KTUtil.getCssVariableValue("--bs-border-dashed-color"), r = {series: [{name: "Sales", data: [15, 12, 10, 8, 7]}], chart: {fontFamily: "inherit", type: "bar", height: 350, toolbar: {show: false}}, plotOptions: {bar: {borderRadius: 8, horizontal: true, distributed: true, barHeight: 50, dataLabels: {position: "bottom"}}}, dataLabels: {enabled: true, textAnchor: "start", offsetX: 0, formatter: function (e, t) {
                        e *= 1e3;
                        return wNumb({thousand: ","}).to(e);
                    }, style: {fontSize: "14px", fontWeight: "600", align: "left"}}, legend: {show: false}, colors: ["#3E97FF", "#F1416C", "#50CD89", "#FFC700", "#7239EA"], xaxis: {categories: ["ECR - 90%", "FGI - 82%", "EOQ - 75%", "FMG - 60%", "PLG - 50%"], labels: {formatter: function (e) {
                            return e + "K";
                        }, style: {colors: [a], fontSize: "14px", fontWeight: "600", align: "left"}}, axisBorder: {show: false}}, yaxis: {labels: {formatter: function (e, t) {
                            return Number.isInteger(e) ? e + " - " + parseInt(100 * e / 18).toString() + "%" : e;
                        }, style: {colors: a, fontSize: "14px", fontWeight: "600"}, offsetY: 2, align: "left"}}, grid: {borderColor: l, xaxis: {lines: {show: true}}, yaxis: {lines: {show: false}}, strokeDashArray: 4}, tooltip: {style: {fontSize: "12px"}, y: {formatter: function (e) {
...
var KTChartsWidget7 = function () {
    var e = function (e) {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-border-dashed-color"), r = {series: [{name: "Net Profit", data: data1}, {name: "Revenue", data: data2}], chart: {fontFamily: "inherit", type: "bar", height: a, toolbar: {show: false}}, plotOptions: {bar: {horizontal: false, columnWidth: ["40%"], borderRadius: [6]}}, legend: {show: false}, dataLabels: {enabled: false}, stroke: {show: true, width: 2, colors: ["transparent"]}, xaxis: {categories: ["Feb", "Mar", "Apr", "May", "Jun", "Jul"], axisBorder: {show: false}, axisTicks: {show: false}, labels: {style: {colors: KTUtil.getCssVariableValue("--bs-gray-700"), fontSize: "12px"}}}, yaxis: {labels: {style: {colors: KTUtil.getCssVariableValue("--bs-gray-700"), fontSize: "12px"}}}, fill: {opacity: 1}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, y: {formatter: function (e) {
                            return "$" + e + " thousands";
                        }}}, colors: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-primary-light")], grid: {borderColor: l, strokeDashArray: 4, yaxis: {lines: {show: true}}}}, o = new ApexCharts(t, r), i = false, s = document.querySelector(tabSelector);
            true === initByDefault && (o.render(), i = true), s.addEventListener("shown.bs.tab", function (e) {
                0 == i && (o.render(), i = true);
...
var KTChartsWidget8 = function () {
    var e = {self: null, rendered: false}, t = {self: null, rendered: false}, a = function (e, t, a, l, r) {
        var o = document.querySelector(a);
        if (o) {
            var i = parseInt(KTUtil.css(o, "height")), s = KTUtil.getCssVariableValue("--bs-border-dashed-color"), n = {series: [{name: "Social Campaigns", data: l[0]}, {name: "Email Newsletter", data: l[1]}, {name: "TV Campaign", data: l[2]}, {name: "Google Ads", data: l[3]}, {name: "Courses", data: l[4]}, {name: "Radio", data: l[5]}], chart: {fontFamily: "inherit", type: "bubble", height: i, toolbar: {show: false}}, plotOptions: {bubble: {}}, stroke: {show: false, width: 0}, legend: {show: false}, dataLabels: {enabled: false}, xaxis: {type: "numeric", tickAmount: 7, min: 0, max: 700, axisBorder: {show: false}, axisTicks: {show: true, height: 0}, labels: {show: true, trim: true, style: {colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px"}}}, yaxis: {tickAmount: 7, min: 0, max: 700, labels: {style: {colors: KTUtil.getCssVariableValue("--bs-gray-500"), fontSize: "13px"}}}, tooltip: {style: {fontSize: "12px"}, x: {formatter: function (e) {
                            return "Clicks: " + e;
                        }}, y: {formatter: function (e) {
                            return "$" + e + "K";
                        }}, z: {title: "Impression: "}}, crosshairs: {show: true, position: "front", stroke: {color: KTUtil.getCssVariableValue("--bs-border-dashed-color"), width: 1, dashArray: 0}}, colors: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-success"), KTUtil.getCssVariableValue("--bs-warning"), KTUtil.getCssVariableValue("--bs-danger"), KTUtil.getCssVariableValue("--bs-info"), "#43CED7"], fill: {opacity: 1}, markers: {strokeWidth: 0}, grid: {borderColor: s, strokeDashArray: 4, padding: {right: 20}, yaxis: {lines: {show: true}}}};
    ...
    return {init: function () {
            var l = [[[100, 250, 30]], [[225, 300, 35]], [[300, 350, 25]], [[350, 350, 20]], [[450, 400, 25]], [[550, 350, 35]]], r = [[[125, 300, 40]], [[250, 350, 35]], [[350, 450, 30]], [[450, 250, 25]], [[500, 500, 30]], [[600, 250, 28]]];
            a(e, "#kt_chart_widget_8_week_toggle", "#kt_chart_widget_8_week_chart", l, false), a(t, "#kt_chart_widget_8_month_toggle", "#kt_chart_widget_8_month_chart", r, true);
            KTThemeMode.on("kt.thememode.change", function () {
...
var KTChartsWidget9 = function () {
    var e = {self: null, rendered: false}, t = function () {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), l = KTUtil.getCssVariableValue("--bs-gray-400"), r = KTUtil.getCssVariableValue("--bs-border-dashed-color"), o = KTUtil.getCssVariableValue("--bs-gray-200"), i = KTUtil.getCssVariableValue("--bs-primary"), s = {series: [{name: "Order", data: [21, 21, 26, 26, 31, 31, 27]}, {name: "Revenue", data: [12, 16, 16, 21, 21, 18, 18]}], chart: {fontFamily: "inherit", type: "area", height: a, toolbar: {show: false}}, plotOptions: {}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "solid", opacity: 1}, stroke: {curve: "smooth", colors: [o]}, xaxis: {categories: ["", "06 Sep", "13 Sep", "20 Sep", "27 Sep", "30 Sep", ""], axisBorder: {show: false}, axisTicks: {show: false}, labels: {style: {colors: l, fontSize: "12px"}}, crosshairs: {position: "front", stroke: {color: l, width: 1, dashArray: 3}}, tooltip: {enabled: true, formatter: void 0, offsetY: 0, style: {fontSize: "12px"}}}, yaxis: {labels: {style: {colors: l, fontSize: "12px"}}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {style: {fontSize: "12px"}, y: {formatter: function (e) {
                            return "$" + e + " thousands";
                        }}}, crosshairs: {show: true, position: "front", stroke: {color: KTUtil.getCssVariableValue("--bs-border-dashed-color"), width: 1, dashArray: 0}}, colors: [o, i], grid: {borderColor: r, strokeDashArray: 4, yaxis: {lines: {show: true}}}, markers: {colors: [o, i], strokeColor: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-gray-300")], strokeWidth: 3}};
            e.self = new ApexCharts(t, s), setTimeout(function () {
                e.self.render(), e.rendered = true;
            }, 200);
        }
...
var KTTablesWidget14 = function () {
    var e = {self: null, rendered: false}, t = {self: null, rendered: false}, a = {self: null, rendered: false}, l = {self: null, rendered: false}, r = {self: null, rendered: false}, o = function (e, t, a, l) {
        var r = document.querySelector(t);
        if (r) {
            var o = parseInt(KTUtil.css(r, "height")), i = r.getAttribute("data-kt-chart-color"), s = KTUtil.getCssVariableValue("--bs-gray-300"), n = KTUtil.getCssVariableValue("--bs-" + i), d = KTUtil.getCssVariableValue("--bs-body-bg"), m = {series: [{name: "Net Profit", data: a}], chart: {fontFamily: "inherit", type: "area", height: o, toolbar: {show: false}, zoom: {enabled: false}, sparkline: {enabled: true}}, plotOptions: {}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "solid", opacity: 1}, stroke: {curve: "smooth", show: true, width: 2, colors: [n]}, xaxis: {axisBorder: {show: false}, axisTicks: {show: false}, labels: {show: false}, crosshairs: {show: false, position: "front", stroke: {color: s, width: 1, dashArray: 3}}, tooltip: {enabled: false}}, yaxis: {min: 0, max: 60, labels: {show: false}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {enabled: false}, colors: [d], markers: {colors: [d], strokeColor: [n], strokeWidth: 3}};
            e.self = new ApexCharts(r, m), true === l && setTimeout(function () {
                e.self.render(), e.rendered = true;
            }, 200);
        }
    };
    return {init: function () {
            ...
            o(e, "#kt_table_widget_14_chart_1", i, true);
            var s = [17, 5, 23, 2, 21, 9, 17, 23, 4, 24, 9, 17, 21, 7];
            o(t, "#kt_table_widget_14_chart_2", s, true);
            var n = [2, 24, 5, 17, 7, 2, 12, 24, 5, 24, 2, 8, 12, 7];
            o(a, "#kt_table_widget_14_chart_3", n, true);
            var d = [24, 3, 5, 19, 3, 7, 25, 14, 5, 14, 2, 8, 5, 17];
            o(l, "#kt_table_widget_14_chart_4", d, true);
            var m = [3, 23, 1, 19, 3, 17, 3, 9, 25, 4, 2, 18, 25, 3];
            o(r, "#kt_table_widget_14_chart_5", m, true), KTThemeMode.on("kt.thememode.change", function () {
...
var KTTablesWidget15 = function () {
    var e = {self: null, rendered: false}, t = {self: null, rendered: false}, a = {self: null, rendered: false}, l = {self: null, rendered: false}, r = {self: null, rendered: false}, o = function (e, t, a, l) {
        var r = document.querySelector(t);
        if (r) {
            var o = parseInt(KTUtil.css(r, "height")), i = r.getAttribute("data-kt-chart-color"), s = KTUtil.getCssVariableValue("--bs-gray-300"), n = KTUtil.getCssVariableValue("--bs-" + i), d = KTUtil.getCssVariableValue("--bs-body-bg"), m = {series: [{name: "Net Profit", data: a}], chart: {fontFamily: "inherit", type: "area", height: o, toolbar: {show: false}, zoom: {enabled: false}, sparkline: {enabled: true}}, plotOptions: {}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "solid", opacity: 1}, stroke: {curve: "smooth", show: true, width: 2, colors: [n]}, xaxis: {axisBorder: {show: false}, axisTicks: {show: false}, labels: {show: false}, crosshairs: {show: false, position: "front", stroke: {color: s, width: 1, dashArray: 3}}, tooltip: {enabled: false}}, yaxis: {min: 0, max: 60, labels: {show: false, ontSize: "12px"}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {enabled: false}, colors: [d], markers: {colors: [d], strokeColor: [n], strokeWidth: 3}};
            e.self = new ApexCharts(r, m), true === l && setTimeout(function () {
                e.self.render(), e.rendered = true;
            }, 200);
        }
    ...
    return {init: function () {
            var i = [7, 10, 5, 21, 6, 11, 5, 23, 5, 11, 18, 7, 21, 13];
            o(e, "#kt_table_widget_15_chart_1", i, true);
            var s = [17, 5, 23, 2, 21, 9, 17, 23, 4, 24, 9, 17, 21, 7];
            o(t, "#kt_table_widget_15_chart_2", s, true);
            var n = [2, 24, 5, 17, 7, 2, 12, 24, 5, 24, 2, 8, 12, 7];
            o(a, "#kt_table_widget_15_chart_3", n, true);
            var d = [24, 3, 5, 19, 3, 7, 25, 14, 5, 14, 2, 8, 5, 17];
            o(l, "#kt_table_widget_15_chart_4", d, true);
            var m = [3, 23, 1, 19, 3, 17, 3, 9, 25, 4, 2, 18, 25, 3];
            o(r, "#kt_table_widget_15_chart_5", m, true), KTThemeMode.on("kt.thememode.change", function () {
...
var KTTablesWidget16 = function () {
    var e = {self: null, rendered: false}, t = {self: null, rendered: false}, a = {self: null, rendered: false}, l = {self: null, rendered: false}, r = {self: null, rendered: false}, o = {self: null, rendered: false}, i = {self: null, rendered: false}, s = {self: null, rendered: false}, n = {self: null, rendered: false}, d = {self: null, rendered: false}, m = {self: null, rendered: false}, c = {self: null, rendered: false}, g = {self: null, rendered: false}, f = {self: null, rendered: false}, u = {self: null, rendered: false}, h = {self: null, rendered: false}, p = {self: null, rendered: false}, y = {self: null, rendered: false}, _ = {self: null, rendered: false}, b = {self: null, rendered: false}, v = function (e, t, a, l, r) {
        var o = document.querySelector(a);
        if (o) {
            var i = parseInt(KTUtil.css(o, "height")), s = o.getAttribute("data-kt-chart-color"), n = (KTUtil.getCssVariableValue("--bs-gray-800"), KTUtil.getCssVariableValue("--bs-gray-300")), d = KTUtil.getCssVariableValue("--bs-" + s), m = KTUtil.getCssVariableValue("--bs-body-bg"), c = {series: [{name: "Net Profit", data: l}], chart: {fontFamily: "inherit", type: "area", height: i, toolbar: {show: false}, zoom: {enabled: false}, sparkline: {enabled: true}}, plotOptions: {}, legend: {show: false}, dataLabels: {enabled: false}, fill: {type: "solid", opacity: 1}, stroke: {curve: "smooth", show: true, width: 2, colors: [d]}, xaxis: {axisBorder: {show: false}, axisTicks: {show: false}, labels: {show: false}, crosshairs: {show: false, position: "front", stroke: {color: n, width: 1, dashArray: 3}}, tooltip: {enabled: false}}, yaxis: {min: 0, max: 60, labels: {show: false, ontSize: "12px"}}, states: {normal: {filter: {type: "none", value: 0}}, hover: {filter: {type: "none", value: 0}}, active: {allowMultipleDataPointsSelection: false, filter: {type: "none", value: 0}}}, tooltip: {enabled: false}, colors: [m], markers: {colors: [m], strokeColor: [d], strokeWidth: 3}};
    ...
    return {init: function () {
            ...
            v(e, "#kt_stats_widget_16_tab_link_1", "#kt_table_widget_16_chart_1_1", w, true);
            var T = [8, 5, 16, 3, 23, 16, 11, 15, 3, 11, 15, 7, 17, 9];
            v(t, "#kt_stats_widget_16_tab_link_1", "#kt_table_widget_16_chart_1_2", T, true);
            var k = [8, 6, 16, 3, 23, 16, 11, 14, 3, 11, 15, 8, 17, 9];
            v(a, "#kt_stats_widget_16_tab_link_1", "#kt_table_widget_16_chart_1_3", k, true);
            var x = [12, 5, 23, 12, 21, 9, 17, 20, 4, 24, 9, 13, 18, 9];
            v(l, "#kt_stats_widget_16_tab_link_1", "#kt_table_widget_16_chart_1_4", x, true);
            var A = [13, 10, 15, 21, 6, 11, 5, 21, 5, 12, 18, 7, 21, 13];
            v(r, "#kt_stats_widget_16_tab_link_2", "#kt_table_widget_16_chart_2_1", A, false);
            var C = [13, 5, 21, 12, 21, 9, 17, 20, 4, 23, 9, 17, 21, 7];
            v(o, "#kt_stats_widget_16_tab_link_2", "#kt_table_widget_16_chart_2_2", C, false);
            var K = [8, 10, 14, 21, 6, 31, 5, 21, 5, 11, 15, 7, 23, 13];
            v(i, "#kt_stats_widget_16_tab_link_2", "#kt_table_widget_16_chart_2_3", K, false);
            var V = [6, 10, 12, 21, 6, 11, 7, 23, 5, 12, 18, 7, 21, 15];
            v(s, "#kt_stats_widget_16_tab_link_2", "#kt_table_widget_16_chart_2_4", V, false);
            var S = [7, 10, 5, 21, 6, 11, 5, 23, 5, 11, 18, 7, 21, 13];
            v(n, "#kt_stats_widget_16_tab_link_3", "#kt_table_widget_16_chart_3_1", S, false);
            var U = [8, 5, 16, 2, 19, 9, 17, 21, 4, 24, 4, 13, 21, 5];
            v(d, "#kt_stats_widget_16_tab_link_3", "#kt_table_widget_16_chart_3_2", U, false);
            var M = [15, 10, 12, 21, 6, 11, 23, 11, 5, 12, 18, 7, 21, 15];
            v(m, "#kt_stats_widget_16_tab_link_3", "#kt_table_widget_16_chart_3_3", M, false);
            var W = [3, 9, 12, 23, 6, 11, 7, 23, 5, 12, 14, 7, 21, 8];
            v(c, "#kt_stats_widget_16_tab_link_3", "#kt_table_widget_16_chart_3_4", W, false);
            var L = [9, 14, 15, 21, 8, 11, 5, 23, 5, 11, 18, 5, 23, 8];
            v(g, "#kt_stats_widget_16_tab_link_4", "#kt_table_widget_16_chart_4_1", L, false);
            var z = [7, 5, 23, 12, 21, 9, 17, 15, 4, 24, 9, 17, 21, 7];
            v(f, "#kt_stats_widget_16_tab_link_4", "#kt_table_widget_16_chart_4_2", z, false);
            var D = [8, 10, 14, 21, 6, 31, 8, 23, 5, 3, 14, 7, 21, 12];
            v(u, "#kt_stats_widget_16_tab_link_4", "#kt_table_widget_16_chart_4_3", D, false);
            var O = [6, 12, 12, 19, 6, 11, 7, 23, 5, 12, 18, 7, 21, 15];
            v(h, "#kt_stats_widget_16_tab_link_4", "#kt_table_widget_16_chart_4_4", O, false);
            var F = [5, 10, 15, 21, 6, 11, 5, 23, 5, 11, 17, 7, 21, 13];
            v(p, "#kt_stats_widget_16_tab_link_5", "#kt_table_widget_16_chart_5_1", F, false);
            var I = [4, 5, 23, 12, 21, 9, 17, 15, 4, 24, 9, 17, 21, 7];
            v(y, "#kt_stats_widget_16_tab_link_5", "#kt_table_widget_16_chart_5_2", I, false);
            var P = [7, 10, 14, 21, 6, 31, 5, 23, 5, 11, 15, 7, 21, 17];
            v(_, "#kt_stats_widget_16_tab_link_5", "#kt_table_widget_16_chart_5_3", P, false);
            var R = [3, 10, 12, 23, 6, 11, 7, 22, 5, 12, 18, 7, 21, 14];
            v(b, "#kt_stats_widget_16_tab_link_5", "#kt_table_widget_16_chart_5_4", R, false), KTThemeMode.on("kt.thememode.change", function () {
...
var KTTablesWidget3 = function () {
    ...
    return {init: function () {
            (e = document.querySelector("#kt_widget_table_3")) && (t = $(e).DataTable({info: false, order: [], paging: false, pageLength: false}), (() => {
                const e = document.querySelector('[data-kt-table-widget-3="tabs_nav"]').querySelectorAll('[data-kt-table-widget-3="tab"]'), a = ["border-bottom", "border-3", "border-primary"];
                e.forEach(l => {
...
var KTTablesWidget4 = function () {
    ...
    return {init: function () {
            (e = document.querySelector("#kt_table_widget_4_table")) && ((() => {
                ...
                (a = l.cloneNode(true)).classList.remove("d-none"), l.parentNode.removeChild(l), (t = $(e).DataTable({info: false, order: [], lengthChange: false, pageLength: 6, ordering: false, paging: false, columnDefs: [{orderable: false, targets: 0}, {orderable: false, targets: 6}]})).on("draw", function () {
                    s(), o();
                });
...
var KTTablesWidget5 = function () {
    ...
    return {init: function () {
            ...
            }), t = $(e).DataTable({info: false, order: [], lengthChange: false, pageLength: 6, paging: false, columnDefs: [{orderable: false, targets: 1}]}), a());
        }};
}();
        ...
        document.querySelectorAll('[data-kt-timeline-widget-1="tab"]').forEach(e => {
            e.addEventListener("shown.bs.tab", a => {
                "#kt_timeline_widget_1_tab_week" === e.getAttribute("href") && (() => {
                    ...
                    var a = Date.now(), l = e.getAttribute("data-kt-timeline-widget-1-image-root"), r = new vis.DataSet([{id: 1, content: "Research", order: 1}, {id: 2, content: "Phase 2.6 QA", order: 2}, {id: 3, content: "UI Design", order: 3}, {id: 4, content: "Development", order: 4}]), o = new vis.DataSet([{id: 1, group: 1, start: a, end: moment(a).add(7, "days"), content: "Framework", progress: "71%", color: "primary", users: ["avatars/300-6.jpg", "avatars/300-1.jpg"]}, {id: 2, group: 2, start: moment(a).add(7, "days"), end: moment(a).add(14, "days"), content: "Accessibility", progress: "84%", color: "success", users: ["avatars/300-2.jpg"]}, {id: 3, group: 3, start: moment(a).add(3, "days"), end: moment(a).add(20, "days"), content: "Microsites", progress: "69%", color: "danger", users: ["avatars/300-5.jpg", "avatars/300-20.jpg"]}, {id: 4, group: 4, start: moment(a).add(10, "days"), end: moment(a).add(21, "days"), content: "Deployment", progress: "74%", color: "info", users: ["avatars/300-23.jpg", "avatars/300-12.jpg", "avatars/300-9.jpg"]}]), i = {zoomable: false, moveable: false, selectable: false, margin: {item: {horizontal: 10, vertical: 35}}, showCurrentTime: false, xss: {disabled: false, filterOptions: {whiteList: {div: ["class", "style"], img: ["data-kt-timeline-avatar-src", "alt"], a: ["href", "class"]}}}, template: function (e) {
                            const t = e.users;
                            let a = "";
                            return t.forEach(e => {
                    ...
                    if (!e) return;
                    if (e.innerHTML) return;
                    var a = Date.now(), l = e.getAttribute("data-kt-timeline-widget-1-image-root"), r = new vis.DataSet([{id: "research", content: "Research", order: 1}, {id: "qa", content: "Phase 2.6 QA", order: 2}, {id: "ui", content: "UI Design", order: 3}, {id: "dev", content: "Development", order: 4}]), o = new vis.DataSet([{id: 1, group: "research", start: a, end: moment(a).add(2, "months"), content: "Tags", progress: "79%", color: "primary", users: ["avatars/300-6.jpg", "avatars/300-1.jpg"]}, {id: 2, group: "qa", start: moment(a).add(0.5, "months"), end: moment(a).add(5, "months"), content: "Testing", progress: "64%", color: "success", users: ["avatars/300-2.jpg"]}, {id: 3, group: "ui", start: moment(a).add(2, "months"), end: moment(a).add(6.5, "months"), content: "Media", progress: "82%", color: "danger", users: ["avatars/300-5.jpg", "avatars/300-20.jpg"]}, {id: 4, group: "dev", start: moment(a).add(4, "months"), end: moment(a).add(7, "months"), content: "Plugins", progress: "58%", color: "info", users: ["avatars/300-23.jpg", "avatars/300-12.jpg", "avatars/300-9.jpg"]}]), i = {zoomable: false, moveable: false, selectable: false, margin: {item: {horizontal: 10, vertical: 35}}, showCurrentTime: false, xss: {disabled: false, filterOptions: {whiteList: {div: ["class", "style"], img: ["data-kt-timeline-avatar-src", "alt"], a: ["href", "class"]}}}, template: function (e) {
                            const t = e.users;
                            let a = "";
                            return t.forEach(e => {
                                a += `<div class="symbol symbol-circle symbol-25px"><img data-kt-timeline-avatar-src="${l + e}" alt="" /></div>`;
        ...
        document.querySelectorAll('[data-kt-timeline-widget-4="tab"]').forEach(e => {
            e.addEventListener("shown.bs.tab", a => {
                "#kt_timeline_widget_4_tab_week" === e.getAttribute("href") && (() => {
                    ...
                    if (!e) return;
                    if (e.innerHTML) return;
                    var a = Date.now(), l = e.getAttribute("data-kt-timeline-widget-4-image-root"), r = new vis.DataSet([{id: 1, content: "Research", order: 1}, {id: 2, content: "Phase 2.6 QA", order: 2}, {id: 3, content: "UI Design", order: 3}, {id: 4, content: "Development", order: 4}]), o = new vis.DataSet([{id: 1, group: 1, start: a, end: moment(a).add(7, "days"), content: "Framework", progress: "71%", color: "primary", users: ["avatars/300-6.jpg", "avatars/300-1.jpg"]}, {id: 2, group: 2, start: moment(a).add(7, "days"), end: moment(a).add(14, "days"), content: "Accessibility", progress: "84%", color: "success", users: ["avatars/300-2.jpg"]}, {id: 3, group: 3, start: moment(a).add(3, "days"), end: moment(a).add(20, "days"), content: "Microsites", progress: "69%", color: "danger", users: ["avatars/300-5.jpg", "avatars/300-20.jpg"]}, {id: 4, group: 4, start: moment(a).add(10, "days"), end: moment(a).add(21, "days"), content: "Deployment", progress: "74%", color: "info", users: ["avatars/300-23.jpg", "avatars/300-12.jpg", "avatars/300-9.jpg"]}]), i = {zoomable: false, moveable: false, selectable: false, margin: {item: {horizontal: 10, vertical: 35}}, showCurrentTime: false, xss: {disabled: false, filterOptions: {whiteList: {div: ["class", "style"], img: ["data-kt-timeline-avatar-src", "alt"], a: ["href", "class"]}}}, template: function (e) {
                            const t = e.users;
                            let a = "";
                            return t.forEach(e => {
                                a += `<div class="symbol symbol-circle symbol-25px"><img data-kt-timeline-avatar-src="${l + e}" alt="" /></div>`;
                    ...
                    if (!e) return;
                    if (e.innerHTML) return;
                    var a = Date.now(), l = e.getAttribute("data-kt-timeline-widget-4-image-root"), r = new vis.DataSet([{id: "research", content: "Research", order: 1}, {id: "qa", content: "Phase 2.6 QA", order: 2}, {id: "ui", content: "UI Design", order: 3}, {id: "dev", content: "Development", order: 4}]), o = new vis.DataSet([{id: 1, group: "research", start: a, end: moment(a).add(2, "months"), content: "Tags", progress: "79%", color: "primary", users: ["avatars/300-6.jpg", "avatars/300-1.jpg"]}, {id: 2, group: "qa", start: moment(a).add(0.5, "months"), end: moment(a).add(5, "months"), content: "Testing", progress: "64%", color: "success", users: ["avatars/300-2.jpg"]}, {id: 3, group: "ui", start: moment(a).add(2, "months"), end: moment(a).add(6.5, "months"), content: "Media", progress: "82%", color: "danger", users: ["avatars/300-5.jpg", "avatars/300-20.jpg"]}, {id: 4, group: "dev", start: moment(a).add(4, "months"), end: moment(a).add(7, "months"), content: "Plugins", progress: "58%", color: "info", users: ["avatars/300-23.jpg", "avatars/300-12.jpg", "avatars/300-9.jpg"]}]), i = {zoomable: false, moveable: false, selectable: false, margin: {item: {horizontal: 10, vertical: 35}}, showCurrentTime: false, xss: {disabled: false, filterOptions: {whiteList: {div: ["class", "style"], img: ["data-kt-timeline-avatar-src", "alt"], a: ["href", "class"]}}}, template: function (e) {
                            const t = e.users;
                            let a = "";
                            return t.forEach(e => {
                                a += `<div class="symbol symbol-circle symbol-25px"><img data-kt-timeline-avatar-src="${l + e}" alt="" /></div>`;
                    ...
                    if (!e) return;
                    if (e.innerHTML) return;
                    var a = Date.now(), l = e.getAttribute("data-kt-timeline-widget-4-image-root"), r = new vis.DataSet([{id: "research", content: "Research", order: 1}, {id: "qa", content: "Phase 2.6 QA", order: 2}, {id: "ui", content: "UI Design", order: 3}, {id: "dev", content: "Development", order: 4}]), o = new vis.DataSet([{id: 1, group: "research", start: a, end: moment(a).add(2, "months"), content: "Tags", progress: "51%", color: "primary", users: ["avatars/300-7.jpg", "avatars/300-2.jpg"]}, {id: 2, group: "qa", start: moment(a).add(0.5, "months"), end: moment(a).add(5, "months"), content: "Testing", progress: "64%", color: "success", users: ["avatars/300-2.jpg"]}, {id: 3, group: "ui", start: moment(a).add(2, "months"), end: moment(a).add(6.5, "months"), content: "Media", progress: "54%", color: "danger", users: ["avatars/300-5.jpg", "avatars/300-21.jpg"]}, {id: 4, group: "dev", start: moment(a).add(4, "months"), end: moment(a).add(7, "months"), content: "Plugins", progress: "348%", color: "info", users: ["avatars/300-3.jpg", "avatars/300-11.jpg", "avatars/300-13.jpg"]}]), i = {zoomable: false, moveable: false, selectable: false, margin: {item: {horizontal: 10, vertical: 35}}, showCurrentTime: false, xss: {disabled: false, filterOptions: {whiteList: {div: ["class", "style"], img: ["data-kt-timeline-avatar-src", "alt"], a: ["href", "class"]}}}, template: function (e) {
                            const t = e.users;
                            let a = "";
                            return t.forEach(e => {
                                a += `<div class="symbol symbol-circle symbol-25px"><img data-kt-timeline-avatar-src="${l + e}" alt="" /></div>`;
